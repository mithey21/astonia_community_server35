...
int process_task(unsigned char *taskdata) {
    ...
    case 0:
        ...
        break;
    case 1:
        del = set_task((void *)(taskdata), (int (*)(void *, struct character *))set_clan_rank);
        break;
    case 2:
        del = set_task((void *)(taskdata), (int (*)(void *, struct character *))fire_from_clan);
        break;
    case 5:
        del = set_task((void *)(taskdata), (int (*)(void *, struct character *))set_flags);
        break;

    default:
        elog("deleting unknown task %d", task);
        del = 1;
        break;
    }
