...
void nomad_parse(int cn, struct nomad_data *dat) {
    ...
    for (ptr = nextnv(ch[cn].arg, name, value); ptr; ptr = nextnv(ptr, name, value)) {
        if (!strcmp(name, "nr")) {
            dat->nr = atoi(value);
        } else if (!strcmp(name, "diceskill")) {
            dat->dice_skill = atoi(value);
        } else if (!strcmp(name, "minbet")) {
            dat->min_bet = atoi(value);
        } else if (!strcmp(name, "maxbet")) {
            dat->max_bet = atoi(value);
        } else if (!strcmp(name, "maxloss")) {
            dat->max_loss = atoi(value);
...
int nomad_1(int cn, int co, struct nomad_ppd *ppd, int nr) {
    ...
    case 1:
        ...
        return 1;
    case 2:
        say(cn, "We value not what the city-folks call money. We have no use for it. Most of our trades work in skins or salt for both are important for our survival.");
        ppd->nomad_state[nr]++;
        return 1;
    case 3:
        say(cn, "We are fierce warriors, and our shaman's magic is deadly. Each tribe of the Vana Laka is loyal only to its members, and, to a certain degree, to the members of the other tribes.");
        ppd->nomad_state[nr]++;
        return 1;
    case 4:
        say(cn, "Those who are tribe-less will have a hard time finding trade partners, or opponents for °c4Llakal Sla°c0.");
        ppd->nomad_state[nr]++;
        return 1;
    case 5:
        say(cn, "If thou wishest to earn membership in my tribe, the Vana Kiru, thou must prove thy worth to us. Collect 100 ounces of salt and hand them to me, and I will welcome thee to the Vana Kiru.");
        ppd->nomad_state[nr]++;
        return 1;
    case 6:
        ...
        return 1;
    case 7:
        say(cn, "Kan vana ley, %s - go in peace.", ch[co].name);
        ppd->nomad_state[nr]++;
        return 1;
    case 8:
        return 0; // waiting for salt
    case 9:
        say(cn, "Mayest thy step be light and thy pockets filled with salt.");
        ppd->nomad_state[nr]++;
        return 1;
    case 10:
        return 0; // we're done.
...
int nomad_2(int cn, int co, struct nomad_ppd *ppd, int nr) {
    ...
    switch (ppd->nomad_state[nr]) {
    case 0:
        if (!(ppd->tribe_member & TM_TRIBE1)) break;
        say(cn, "Sul vana ley, %s. I am %s.", ch[co].name, ch[cn].name);
        ppd->nomad_state[nr]++;
        return 1;
    case 1:
        say(cn, "I have a nice collection of dice. I'd sell thee a set of °c4cheap dice°c0 for 200 ounces of salt, or a set of °c4mediocre dice°c0 for 500 ounces, or a set of °c4 good dice°c0 for 1200 ounces.");
        ppd->nomad_state[nr]++;
        return 1;
    case 2:
        return 0; // finished
...
int nomad_3(int cn, int co, struct nomad_ppd *ppd, int nr) {
    ...
    case 0:
        ...
        return 1;
    case 1:
        say(cn, "Would you like a game of °c4Llakal Sla°c0?");
        ppd->nomad_state[nr]++;
        return 1;
    case 2:
        return 0; // finished
...
int nomad_4(int cn, int co, struct nomad_ppd *ppd, int nr) {
    ...
    switch (ppd->nomad_state[nr]) {
    case 0:
        say(cn, "Welcome to the monastery of Kir Laka, %s. I am %s.", ch[co].name, ch[cn].name);
        questlog_open(co, 33);
        ppd->nomad_state[nr]++;
        return 1;
    case 1:
...
int nomad_5(int cn, int co, struct nomad_ppd *ppd, int nr) {
    ...
    switch (ppd->nomad_state[nr]) {
    case 0:
        say(cn, "Welcome to the monastery of Kir Laka, %s. I am %s, the teacher.", ch[co].name, ch[cn].name);
        questlog_open(co, 34);
        ppd->nomad_state[nr]++;
        return 1;
    case 1:
        say(cn, "We of the Kir believe in life, and in the mastery of life. The concept of god-hood is alien to us; and while we value Ishtar's fight against the demonic hordes, we do not believe he is a god. But enough of Ishtar.");
        ppd->nomad_state[nr]++;
        return 1;
    case 2:
        say(cn, "I can teach thee about life, in exchange for a golden statue of Kir. One of the nomads sells them.");
        ppd->nomad_state[nr]++;
        return 1;
    case 3:
...
int nomad_6(int cn, int co, struct nomad_ppd *ppd, int nr) {
    ...
    case 0:
        ...
        return 1;
    case 1:
        say(cn, "Wouldst thou like to buy a °c4golden statue°c0? I shall give it to thee for only 10000 ounces of salt!");
        ppd->nomad_state[nr]++;
        return 1;
    case 2:
        return 0; // finished
...
void nomad_1_repeat(int cn, int co, struct nomad_ppd *ppd, int nr) {
    ...
    if (ppd->nomad_state[nr] >= 0 && ppd->nomad_state[nr] <= 8) {
        ppd->nomad_state[nr] = 0;
        return;
    }
    if (ppd->nomad_state[nr] >= 9 && ppd->nomad_state[nr] <= 10) {
...
void nomad_2_repeat(int cn, int co, struct nomad_ppd *ppd, int nr) {
    ...
    if (ppd->nomad_state[nr] >= 0 && ppd->nomad_state[nr] <= 2) {
        ppd->nomad_state[nr] = 0;
        return;
    }
}
...
void nomad_4_repeat(int cn, int co, struct nomad_ppd *ppd, int nr) {
    ...
    if (ppd->nomad_state[nr] >= 0 && ppd->nomad_state[nr] <= 3) {
        ppd->nomad_state[nr] = 0;
        return;
    }
    if (ppd->nomad_state[nr] >= 4 && ppd->nomad_state[nr] <= 5) {
...
void nomad_bet(int cn, struct nomad_data *dat, int co, int val, struct nomad_ppd *ppd, int nr) {
    ...
    if (ppd->open_bet) {
        ...
        d1 = lucky_die(6, dat->dice_skill);
        d2 = lucky_die(6, dat->dice_skill);
        d3 = lucky_die(6, dat->dice_skill);
    }
        ...
        if (msg->type == NT_CHAR) {
            ...
            if ((ch[co].flags & CF_PLAYER) && ticker - dat->lasttalk > TICKS * 5 && char_dist(cn, co) < 12 && char_see_char(cn, co) && (ppd = set_data(co, DRD_NOMAD_PPD, sizeof(struct nomad_ppd)))) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    didsay = nomad_2(cn, co, ppd, dat->nr);
                    break;
                case 3:
                    didsay = nomad_3(cn, co, ppd, dat->nr);
                    break;
                case 4:
                    didsay = nomad_4(cn, co, ppd, dat->nr);
                    break;
                case 5:
                    didsay = nomad_5(cn, co, ppd, dat->nr);
                    break;
                case 6:
                    didsay = nomad_6(cn, co, ppd, dat->nr);
                    break;
        ...
        if (msg->type == NT_TEXT) {
            ...
            if ((ppd = set_data(co, DRD_NOMAD_PPD, sizeof(struct nomad_ppd)))) {
                ...
                case 2:
                    switch (dat->nr) {
                    case 1:
                        nomad_1_repeat(cn, co, ppd, dat->nr);
                        dat->lasttalk = 0;
                        break;
                    case 2:
                        nomad_2_repeat(cn, co, ppd, dat->nr);
                        dat->lasttalk = 0;
                        break;
                    case 3:
                        nomad_3_repeat(cn, co, ppd, dat->nr);
                        dat->lasttalk = 0;
                        break;
                    case 4:
                        nomad_4_repeat(cn, co, ppd, dat->nr);
                        dat->lasttalk = 0;
                        break;
                    case 5:
                        nomad_5_repeat(cn, co, ppd, dat->nr);
                        dat->lasttalk = 0;
                        break;
                    case 6:
                        nomad_6_repeat(cn, co, ppd, dat->nr);
                        dat->lasttalk = 0;
                        break;
                    }
                    break;
                ...
                case 6:
                    switch (dat->nr) {
                    case 2:
                        nomad_2_text(cn, co, ppd, dat->nr, res);
                        dat->lasttalk = 0;
                        break;
                    case 6:
                        nomad_6_text(cn, co, ppd, dat->nr, res);
                        dat->lasttalk = 0;
                        break;
                    }
                default:
            ...
            if ((ptr = strstr((char *)msg->dat2, "bet ")) && char_dist(cn, co) < 12 && char_see_char(cn, co)) {
                ...
                if (val) {
                    switch (dat->nr) {
                    case 1:
                        if (ppd->nomad_state[dat->nr] >= 9) nomad_bet(cn, dat, co, val, ppd, dat->nr);
                        else say(cn, "Sorry, I do not play with strangers.");
                        break;
                    case 2:
                        if (ppd->tribe_member & TM_TRIBE1) nomad_bet(cn, dat, co, val, ppd, dat->nr);
                        else say(cn, "Sorry, I do not play with strangers.");
                        break;
                    case 3:
                        if (ppd->tribe_member & TM_TRIBE1) nomad_bet(cn, dat, co, val, ppd, dat->nr);
        ...
        if (msg->type == NT_GIVE) {
            ...
            if ((in = ch[cn].citem)) { // we still have it
                if ((ppd = set_data(co, DRD_NOMAD_PPD, sizeof(struct nomad_ppd)))) {
                    switch (dat->nr) {
                    case 1:
                        if (!nomad_1_give(cn, co, in, ppd, dat->nr) && !give_char_item(co, in)) {
                            destroy_item(in);
                        }
                        ch[cn].citem = 0;
                        break;
                    case 4:
                        if (!nomad_4_give(cn, co, in, ppd, dat->nr) && !give_char_item(co, in)) {
                            destroy_item(in);
                        }
                        ch[cn].citem = 0;
                        break;
                    case 5:
                        if (!nomad_5_give(cn, co, in, ppd, dat->nr) && !give_char_item(co, in)) {
                            destroy_item(in);
                        }
                        ch[cn].citem = 0;
                        break;
