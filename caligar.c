...
void guard_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (realtime - ppd->guard_last_talk < 3) {
                remove_message(cn, msg);
                continue;
            }
            ...
            case 4:
                ...
                break;
            case 5:
                if (realtime - ppd->guard_last_talk > 600) ppd->guard_state = 0;
                break;
            }
        }
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_CALIGAR_PPD, sizeof(struct caligar_ppd));
                if (ppd && ppd->guard_state == 3) {
                    ppd->guard_state = 0;
                    ppd->guard_last_talk = 0;
                }
                break;
            }
        }
...
void glori_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (realtime - ppd->glori_last_talk < 4) {
                remove_message(cn, msg);
                continue;
            }
            ...
            case 0:
                ...
                break;
            case 1:
                quiet_say(cn, "I am Glori, First in charge.");
                ppd->glori_last_talk = realtime;
                ppd->glori_state++;
                didsay = 1;
                break;
            case 2:
                quiet_say(cn, "We must find out what those mages intend to do with that plaque and retrieve it as soon as possible.");
                ppd->glori_last_talk = realtime;
                ppd->glori_state++;
                didsay = 1;
                break;
            ...
            case 5:
                ...
                break;
            case 6:
                log_char(co, LOG_SYSTEM, 0, "You tell Glori what you have seen.");
                ppd->glori_last_talk = realtime;
                ppd->glori_state++;
                didsay = 1;
                break;
            case 7:
                quiet_say(cn, "Ah, good work. Now that we know how the enemies fight, we can prepare ourselves for battle.");
                questlog_done(co, 55);
                questlog_open(co, 56);
                ppd->glori_last_talk = realtime;
                ppd->glori_state++;
                ...
                break;
            case 8:
                quiet_say(cn, "I have gotten a report that there is a dungeon below one of the traders' shops. It is said to lead to a dungeon full of zombies, and I assume there will be two more like it containing skeletons and vampires.");
                ppd->glori_last_talk = realtime;
                ppd->glori_state++;
                didsay = 1;
                break;
            case 9:
                ...
                break;
            case 10:
                if (has_item(co, IID_CALIGAROBELISK1) && has_item(co, IID_CALIGAROBELISK2) && has_item(co, IID_CALIGAROBELISK3)) {
                    questlog_done(co, 56);
                    questlog_open(co, 57);
                    ppd->glori_last_talk = realtime;
                    ppd->glori_state++;
            ...
            case 13:
                quiet_say(cn, "Great job. I feel we are very close to putting an end to those evil mages ways.");
                ppd->glori_last_talk = realtime;
                ppd->glori_state++;
                didsay = 1;
                break;
            case 14:
                quiet_say(cn, "Hmm. It might be a good idea to take the key parts to the blacksmith south west of this library, near the bar. He may be able to forge these together.");
                ppd->glori_last_talk = realtime;
                ppd->glori_state++;
                didsay = 1;
                break;
            case 15:
                ...
                break;
            case 16:
                if (has_item(co, IID_CALIGARDUNGEONKEY)) {
                    questlog_done(co, 58);
                    ppd->glori_last_talk = realtime;
                    ppd->glori_state++;
                    didsay = 1;
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_CALIGAR_PPD, sizeof(struct caligar_ppd));
                if (ppd && ppd->glori_state >= 1 && ppd->glori_state <= 5) {
                    ppd->glori_state = 1;
                    ppd->glori_last_talk = 0;
                }
                if (ppd && ppd->glori_state >= 8 && ppd->glori_state <= 10) {
                    ppd->glori_state = 8;
                    ppd->glori_last_talk = 0;
                }
                if (ppd && ppd->glori_state >= 11 && ppd->glori_state <= 12) {
                    ppd->glori_state = 11;
                    ppd->glori_last_talk = 0;
                }
                if (ppd && ppd->glori_state >= 14 && ppd->glori_state <= 16) {
                    ppd->glori_state = 14;
                    ppd->glori_last_talk = 0;
                }
                if (ppd && ppd->glori_state >= 17 && ppd->glori_state <= 18) {
                    ppd->glori_state = 17;
                    ppd->glori_last_talk = 0;
                }
                break;
...
void arquin_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (realtime - ppd->arquin_last_talk < 4) {
                remove_message(cn, msg);
                continue;
            }
            ...
            case 0:
                if (ppd->glori_state == 12) ppd->arquin_state++; // fall thru
                else break;
            case 1:
                quiet_say(cn, "Obelisks? Well, they may be used as some type of key. Judging by the names of each one I would assume that they open the locked gates inside each training area.");
            ...
            case 4:
                ...
                break;
            case 5:
                quiet_say(cn, "He was banished from this city by his brothers for not helping them with their plans of destruction, and being that this area is barricaded, he had no choice but to establish shelter in the forest.");
                ppd->arquin_last_talk = realtime;
                ppd->arquin_state++;
                didsay = 1;
                break;
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_CALIGAR_PPD, sizeof(struct caligar_ppd));
                if (ppd && ppd->arquin_state >= 1 && ppd->arquin_state <= 3) {
                    ppd->arquin_state = 1;
                    ppd->arquin_last_talk = 0;
                }
                if (ppd && ppd->arquin_state >= 4 && ppd->arquin_state <= 6) {
                    ppd->arquin_state = 4;
                    ppd->arquin_last_talk = 0;
                }
                break;
...
void smith_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (realtime - ppd->smith_last_talk < 4) {
                remove_message(cn, msg);
                continue;
            }
            ...
            case 0:
                if (ppd->glori_state == 16 &&
                    has_item(co, IID_CALIGARKEYP1) &&
                    has_item(co, IID_CALIGARKEYP2) &&
                    has_item(co, IID_CALIGARKEYP3)) ppd->smith_state++; // fall thru
                else break;
            case 1:
                quiet_say(cn, "Hello there. I hear you need a key made. Well, for a small fee of 5000 gold I would be more than willing to do it. °c4Yes, Okay°c0 / °c4No, not today°c0");
            ...
            case 3:
                quiet_say(cn, "This monk named Johnatan is wiser than he should be. He is correct. I do descend from the dwarfs, more closely related to the frawds.");
                ppd->smith_state++;
                ppd->smith_last_talk = realtime;
                didsay = 1;
                break;
            ...
            case 6:
                ...
                break;
            case 7:
                quiet_say(cn, "Well I forged you a key for 5000g, a hand written dictionary like this must be worth at least the double. So °c04pay 10000g°c0 must be a fair price don't you think?");
                ppd->smith_state++;
                ppd->smith_last_talk = realtime;
                didsay = 1;
                break;
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_CALIGAR_PPD, sizeof(struct caligar_ppd));
                if (ppd && ppd->smith_state >= 1 && ppd->smith_state <= 2) {
                    ppd->smith_state = 1;
                    ppd->smith_last_talk = 0;
                }
                if (ppd && ppd->smith_state >= 3 && ppd->smith_state <= 8) {
                    ppd->smith_state = 3;
                    ppd->smith_last_talk = 0;
                }
                break;
...
void homden_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (realtime - ppd->homden_last_talk < 4) {
                remove_message(cn, msg);
                continue;
            }
            ...
            case 1:
                ...
                break;
            case 2:
                quiet_say(cn, "A group of amazons keep invading my camp at night, and stealing my personal things. One item, a powerful ring, was taken and I am sure it was them.");
                ppd->homden_last_talk = realtime;
                ppd->homden_state++;
                didsay = 1;
                break;
            ...
            case 7:
                ...
                break;
            case 8:
                quiet_say(cn, "We can not let this happen. The fate of Astonia depends on those filthy brothers of mine being halted! The door that the key opens can be found down a hole to the north.");
                ppd->homden_last_talk = realtime;
                ppd->homden_state++;
                didsay = 1;
                break;
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_CALIGAR_PPD, sizeof(struct caligar_ppd));
                if (ppd && ppd->homden_state >= 2 && ppd->homden_state <= 4) {
                    ppd->homden_state = 2;
                    ppd->homden_last_talk = 0;
                }
                if (ppd && ppd->homden_state >= 6 && ppd->homden_state <= 11) {
                    ppd->homden_state = 6;
                    ppd->homden_last_talk = 0;
                }
                break;
...
int caligar_weight_door(int in, int cn) {
    ...
    if (dy > 0) {
        ...
        if (!in2 || !in3 || it[in2].driver != IDR_CALIGAR || it[in3].driver != IDR_CALIGAR) {
...
int caligar_item(int in, int cn) {
    ...
    case 1:
        caligar_training(in, cn);
        break;
    case 2:
        caligar_weight(in, cn);
        break;
    case 3:
        return caligar_weight_door(in, cn);
    case 4:
        caligar_weight(in, cn);
        break;
    case 5:
    ...
    case 9:
        ...
        break;
    case 10:
        caligar_key_assembly(in, cn);
        break;
    case 11:
        caligar_extinguish(in, cn);
        break;
    case 12:
        return caligar_skelly_door(in, cn);
    }
    return 1;
}
...
int ch_driver(int nr, int cn, int ret, int lastact) {
    switch (nr) {
    case CDR_CALIGARGUARD:
        guard_driver(cn, ret, lastact);
        return 1;
    case CDR_CALIGARGUARD2:
        guard2_driver(cn, ret, lastact);
        return 1;
    case CDR_CALIGARGLORI:
        glori_driver(cn, ret, lastact);
        return 1;
    case CDR_CALIGARARQUIN:
        arquin_driver(cn, ret, lastact);
        return 1;
    case CDR_CALIGARSMITH:
        smith_driver(cn, ret, lastact);
        return 1;
    case CDR_CALIGARHOMDEN:
        homden_driver(cn, ret, lastact);
        return 1;
    case CDR_CALIGARSKELLY:
        skelly_driver(cn, ret, lastact);
        return 1;
...
int it_driver(int nr, int in, int cn) {
    switch (nr) {
    case IDR_CALIGAR:
        return caligar_item(in, cn);
    case IDR_CALIGARFLAME:
        caligar_flamethrow(in, cn);
        return 1;
    default:
        return 0;
    }
