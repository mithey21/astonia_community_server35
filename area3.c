    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    say(cn, "Welcome to Aston, %s! I am %s, Staff Sergeant of the Seyan'Du, the late emperor's personal guard.", ch[co].name, ch[cn].name);
                    questlog_open(co, 10);
                    ppd->seymour_state++;
                    didsay = 1;
                    break;
                case 1:
                    say(cn, "There are but few of us left. Most died in the defense when the underworld opened and the monsters stormed the imperial palace.");
                    ppd->seymour_state++;
                    didsay = 1;
                    break;
                case 2:
                    say(cn, "Do be wary when thou approachest the palace. It is still in ruins, and monsters appear there from time to time.");
                    ppd->seymour_state++;
                    didsay = 1;
                    break;
                case 3:
                    say(cn, "Some greedy folks tried to loot it, but few have returned with their spoils. Ah, be that as it may. I talk too much.");
                    ppd->seymour_state++;
                    didsay = 1;
                    break;
                case 4:
                    say(cn, "My captain said I was to hire strong looking adventurers for Imperial service. Never before have the Seyan'Du asked for help. But now we do. Oh, what has become of this world?");
                    ppd->seymour_state++;
                    didsay = 1;
                    break;
                case 5:
                    say(cn, "Our emperor murdered, nine of ten killed. Oh my, oh my.");
                    ppd->seymour_state++;
                    didsay = 1;
                    break;
                case 6:
                ...
                case 11:
                    break;
                case 12:
                    ppd->seymour_state = 14; //fall through intended
                case 13:
                    ppd->seymour_state = 14; //fall through intended
                case 14:
                    if (questlog_isdone(co, 12)) {
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_AREA3_PPD, sizeof(struct area3_ppd));
                if (ppd && ppd->seymour_state <= 9) {
                    dat->last_talk = 0;
                    ppd->seymour_state = 0;
                }
                if (ppd && ppd->seymour_state >= 10 && ppd->seymour_state <= 11) {
                    dat->last_talk = 0;
                    ppd->seymour_state = 10;
                }
                if (ppd && ppd->seymour_state >= 12 && ppd->seymour_state <= 13) {
                    dat->last_talk = 0;
                    ppd->seymour_state = 12;
                }
                if (ppd && ppd->seymour_state >= 14 && ppd->seymour_state <= 15) {
                    dat->last_talk = 0;
                    ppd->seymour_state = 14;
                }
                if (ppd && ppd->seymour_state >= 16 && ppd->seymour_state <= 17) {
                    dat->last_talk = 0;
                    ppd->seymour_state = 16;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Greetings, %s! I am %s, First Sergeant of the Seyan'Du, the late emperor's personal guard.", ch[co].name, ch[cn].name);
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 1:
                    if (ppd->seymour_state >= 16) ppd->kelly_state++; // fall through...
                    else break;
                case 2:
                    quiet_say(cn, "Listen, %s. There have been some attacks from beings we call Stone Creepers. They come from the depths below the city. One known entrance is in the park.", get_army_rank_string(co));
                    questlog_open(co, 13);
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 3:
                    quiet_say(cn, "During the last raid, one huge creeper was seen. It did as much damage as all the others together. Go there, and slay it. As proof of thy deed, bring me its head.");
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 4:
                    quiet_say(cn, "That will be all, %s. Dismissed!", get_army_rank_string(co));
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 5:
                    break; // waiting for creeper head
                case 6:
                    if (questlog_isdone(co, 14)) {
                        ppd->kelly_state = 10;
                        break;
                    }
                ...
                case 7:
                    ...
                    break;
                case 8:
                    quiet_say(cn, "Dismissed, %s. And good luck. Thou shalt need it.", get_army_rank_string(co));
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 9:
                    cnt = ppd->kelly_found1 + ppd->kelly_found2 + ppd->kelly_found3;
                    ...
                    break;
                case 10:
                    quiet_say(cn, "I tell thee, %s, all these findings are most unsettling. I think we have but scratched on the surface of this underground world, and I fear what we are yet to find.", ch[co].name);
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 11:
                    quiet_say(cn, "The Imperial Army, the little that is left of it, is exploring the underworld, but our losses are heavy. All of a sudden, holes open everywhere, and monsters start pouring out. We needst find out where they come from, and why they attack us all of a sudden.");
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 12:
                    quiet_say(cn, "The future seemed so bright when Seyan was still alive and Ishtar was here to teach us.");
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 13:
                    if (ch[co].level >= 22) ppd->kelly_state++; // fall thru intended
                    else break;
                case 14:
                    if (questlog_isdone(co, 15)) {
                        ppd->kelly_state = 19;
                        break;
                    }
                    ...
                    break;
                case 15:
                    if (ppd->clara_state >= 5) ppd->kelly_state++; // fall through...
                    else break;
                case 16:
                    quiet_say(cn, "So Clara is well? 'Tis is good to hear, %s. I thank thee.", ch[co].name);
                    questlog_done(co, 15);
                    ...
                    break;
                case 17:
                    quiet_say(cn, "I think Clara is right that we should not send reinforcements yet. But these swamp beasts worry me. I will pay thee for each swamp beast head thou bringst me. The larger the head, the larger the bounty.");
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 18:
                    quiet_say(cn, "Remember to report to Clara again, %s. Dismissed.", ch[co].name);
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 19:
                    if (collect_heads(cn, co)) didsay = 1;
                    if (ch[co].level >= 56) ppd->kelly_state++; // fall thru intended
                    else break;
                case 20:
                    if (questlog_count(co, 60)) {
                        ppd->kelly_state = 26;
                        break;
                    }
                ...
                case 21:
                    ...
                    break;
                case 22:
                    quiet_say(cn, "He found a note that was signed 'Grendom Carmin', a member of the Carmin Clan, who were a group of destructive mages, banished from Aston by the Imperial Army.");
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 23:
                    quiet_say(cn, "They settled in a forest to the south west of Aston and a wall was built so they could not come back.");
                    ppd->kelly_state++;
                    didsay = 1;
                    break;
                case 24:
                    ...
                    break;
                case 25:
                    break; // waiting for caligar plaque
                case 26:
                    break; // all done
                }
                if (didsay) {
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_AREA3_PPD, sizeof(struct area3_ppd));
                if (ppd && ppd->kelly_state <= 5) {
                    dat->last_talk = 0;
                    ppd->kelly_state = 0;
                }
                if (ppd && ppd->kelly_state > 5 && ppd->kelly_state <= 9) {
                    dat->last_talk = 0;
                    ppd->kelly_state = 6;
                }
                if (ppd && ppd->kelly_state >= 10 && ppd->kelly_state <= 13) {
                    dat->last_talk = 0;
                    ppd->kelly_state = 10;
                }
                if (ppd && ppd->kelly_state >= 14 && ppd->kelly_state <= 15) {
                    dat->last_talk = 0;
                    ppd->kelly_state = 14;
                }
                if (ppd && ppd->kelly_state >= 17 && ppd->kelly_state <= 19) {
                    dat->last_talk = 0;
                    ppd->kelly_state = 17;
                }
                if (ppd && ppd->kelly_state >= 21 && ppd->kelly_state <= 25) {
                    dat->last_talk = 0;
                    ppd->kelly_state = 21;
                }
                break;
...
void astro1_driver(int cn, int ret, int lastact) {
    ...
    if (ticker > dat->last_talk + TICKS * 10) {
        switch (dat->state) {
        case 0:
            quiet_say(cn, "The moon, oh so bright and splendid it seemed. Oh, yes.");
            dat->state++;
            break;
        case 1:
            quiet_say(cn, "From my starting point, I moved the telescope to the south-east.");
            dat->state++;
            break;
        case 2:
            quiet_say(cn, "Then I noticed two triangle-shaped boulders. I continued moving south-east.");
            dat->state++;
            break;
        case 3:
            quiet_say(cn, "Some time later, there were one triangle-shaped boulder and one round like a circle. There, I started moving the telescope south-west.");
            dat->state++;
            break;
        case 4:
            quiet_say(cn, "A triangle-shaped boulder there was, and a square one. I turned the telescope south-east again.");
            dat->state++;
            break;
        case 5:
            quiet_say(cn, "Soon after, the perfectly round boulders caught my eye. Perfect circles. I marvelled at their sight - and got hungry, so I stopped to get some food.");
            dat->state++;
            break;
        case 6:
            quiet_say(cn, "After I got the food, I went back to the triangle-shaped and the square boulder. This time, I moved the telescope south-west.");
            dat->state++;
            break;
        case 7:
            quiet_say(cn, "There, I saw two boulders, both perfectly round, like circles. I continued moving south-west.");
            dat->state++;
            break;
        case 8:
            quiet_say(cn, "I moved the telescope past a triangle-shaped boulder, still going south-west.");
            dat->state++;
            break;
        case 9:
            quiet_say(cn, "At the sight of a round boulder, I started moving the telescope south-east.");
            dat->state++;
            break;
        case 10:
            quiet_say(cn, "After looking some more, I spotted the perfect squares. From there on, I moved north-east.");
            dat->state++;
            break;
        case 11:
            quiet_say(cn, "Some time later, I noticed another square and turned south-east again.");
            dat->state++;
            break;
        case 12:
            ...
            break;
        case 13:
            quiet_say(cn, "And there it was, the very thing I was looking for. Oh, it was so beautiful!");
            dat->state++;
            break;
        case 14:
            quiet_say(cn, "Now what did I say last? I better start over at the beginning!");
            dat->state = 0;
            break;
        default:
            dat->state = 0;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    say(cn, "Ah. Hello %s. I am %s, the astronomer.", ch[co].name, ch[cn].name);
                    questlog_open(co, 16);
                    ppd->astro2_state++;
                    didsay = 1;
                    break;
                case 1:
                    ...
                    break;
                case 2:
                    say(cn, "But a few days ago, some strange creatures invaded the garden, and drove us away. We had to leave our notes behind.");
                    ppd->astro2_state++;
                    didsay = 1;
                    break;
                case 3:
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    break;
                case 1:
                    say(cn, "Welcome to my humble home, %s.", ch[co].name);
                    questlog_open(co, 18);
                    ppd->crypt_state++;
                    didsay = 1;
                    break;
                case 2:
                    say(cn, "Thou lookst like a tough %s. I guess thou wouldst be interested to hear about a fabulous opportunity.", (ch[co].flags & CF_WARRIOR) ? "warrior" : "mage");
                    ppd->crypt_state++;
                    didsay = 1;
                    break;
                case 3:
                    say(cn, "One of my clerks found hints about a huge crypt located below the Aston graveyard. Being the coward he is, he rejected to explore it himself, though.");
                    ppd->crypt_state++;
                    didsay = 1;
                    break;
                case 4:
                ...
                case 7:
                    break; // waiting for answer
                case 8:
                    say(cn, "Jolly good. I expect thee to slay the toughest creature thou canst find down there. Have a nice day, %s.", ch[co].name);
                    ppd->crypt_state++;
                    didsay = 1;
                    break;
                case 9:
                ...
                case 13:
                    ...
                    break;
                case 14:
                    break; // waiting for quest to be done
                case 15:
                    break; // quest is done
                }
                if (didsay) {
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 3:
                ...
                if (ppd && ppd->crypt_state >= 6 && ppd->crypt_state <= 7) {
                    ppd->crypt_state = 8;
                    ppd->crypt_bonus = 1;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Hello, %s. I am %s, Chief Investigator of the Occult in the Imperial Army.", ch[co].name, ch[cn].name);
                    ppd->carlos_state++;
                    didsay = 1;
                    questlog_open(co, 20);
                    break;
                case 1:
                    quiet_say(cn, "I need thy help to investigate a strange noise coming from below the crypt. 200 years ago some strange creatures were found.");
                    ppd->carlos_state++;
                    didsay = 1;
                    break;
                case 2:
                    quiet_say(cn, "I sent my top army down to kill theses creatures and take away a special Staff. The staff had magical properties that allowed these creatures to live.");
                    ppd->carlos_state++;
                    didsay = 1;
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    quiet_say(cn, "Please go below the crypt and find out what the strange noise is and if thou findst the staff bring it back to me.");
                    ppd->carlos_state++;
                    didsay = 1;
                    ...
                    break;
                case 5:
                    break; // waiting for staff
                case 6:
                    break; // got staff... waiting forever here.
                }
                if (didsay) {
                    dat->last_talk = ticker;
                    talkdir = offset2dx(ch[cn].x, ch[cn].y, ch[co].x, ch[co].y);
...
int ch_driver(int nr, int cn, int ret, int lastact) {
    switch (nr) {
    case CDR_SEYMOUR:
        seymour_driver(cn, ret, lastact);
        return 1;
    case CDR_LAMPGHOST:
        lampghost_driver(cn, ret, lastact);
        return 1;
    case CDR_KELLY:
        kelly_driver(cn, ret, lastact);
        return 1;
    case CDR_ASTRO1:
        astro1_driver(cn, ret, lastact);
        return 1;
    case CDR_ASTRO2:
        astro2_driver(cn, ret, lastact);
        return 1;
    case CDR_THOMAS:
        thomas_driver(cn, ret, lastact);
        return 1;
    case CDR_SIRJONES:
        sir_jones_driver(cn, ret, lastact);
        return 1;
    case CDR_CARLOS:
        carlos_driver(cn, ret, lastact);
        return 1;
...
int it_driver(int nr, int in, int cn) {
    switch (nr) {
    case IDR_ONOFFLIGHT:
        onofflight_driver(in, cn);
        return 1;
    case IDR_PALACEGATE:
        gate_driver(in, cn);
        return 1;
    case IDR_GATEKEEPER:
        gatekeeper_door_driver(in, cn);
        return 1;
