...
int staffer2_item(int in, int cn) {
    ...
    case 2:
        ...
        break;
    case 3:
        staffer_block_move(in, cn);
        break;
    case 4:
        return staffer_spec_door(in, cn);
    case 5:
        return staffer_spec_door(in, cn);
    case 6:
        staffer_animation_book(in, cn);
        break;
    default:
        elog("unknown staffer item %s type %d", it[in].name, it[in].drdata[0]);
    }
    return 1;
}
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Greetings, %s, welcome to Brannington!", ch[co].name);
                    if (!questlog_isdone(co, 40)) questlog_open(co, 40);
                    ppd->countbran_state++;
                    didsay = 1;
                    break;
                case 1:
                    quiet_say(cn, "My guards told me that you were coming, and they said you might be able to help me with my problems.");
                    ppd->countbran_state++;
                    didsay = 1;
                    break;
                case 2:
                    quiet_say(cn, "You see, my family was recently robbed by three thief mages of our most valuable jewelry, and we would like to ask for your aid.");
                    ppd->countbran_state++;
                    didsay = 1;
                    break;
                case 3:
                    quiet_say(cn, "If you can bring back our jewelry, we would be very thankful indeed.");
                    ppd->countbran_state = 4;
                    didsay = 1;
                    break;
                case 4:
                    break; // waiting for jewelry
                }
                if (didsay) {
            ...
            if (ch[co].flags & CF_PLAYER) {
                ...
                case 3:
                    if (ch[co].flags & CF_GOD) {
                        say(cn, "reset done");
                        ppd->countbran_bits = ppd->countbran_state = ppd->countessabran_state = ppd->daughterbran_state = 0;
                    }
                    break;
                }
                if (didsay) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Greetings stranger... I'm afraid I can't be of much help to you, as I can't recall much, except my name...");
                    questlog_open(co, 41);
                ...
                case 1:
                    ...
                    break;
                case 2:
                    quiet_say(cn, "I overheard my captor say something about a grolm before I got rescued by strangers who dropped me off here and went on their way...");
                    ppd->brennethbran_state++;
                    didsay = 1;
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    break; // waiting for dagger
                case 5:
                    if (questlog_isdone(co, 42)) {
                    ...
                    break;
                case 6:
                    quiet_say(cn, "Maybe I was foolish enough to think I could defeat grolms, and that got the best of me...");
                    ppd->brennethbran_state++;
                    didsay = 1;
                    break;
                case 7:
                    quiet_say(cn, "If you will, please continue looking for more items... Maybe my captor managed to hide something...");
                    ppd->brennethbran_state++;
                    didsay = 1;
                    break;
                case 8:
                    break; // waiting for potion
                case 9:
                    if (questlog_isdone(co, 43)) {
                    ...
                    break;
                case 10:
                    quiet_say(cn, "I just can't imagine why I would want to poison... anyone or anything...");
                    ppd->brennethbran_state++;
                    didsay = 1;
                    break;
                case 11:
                ...
                case 12:
                    ...
                    break;
                case 13:
                    quiet_say(cn, "But I'm going to give that life up now... This loss of memory is perhaps more of a blessing than it is a curse...");
                    ppd->brennethbran_state++;
                    didsay = 1;
                    break;
                case 14:
        ...
        if (msg->type == NT_TEXT) {
            ...
            if (ch[co].flags & CF_PLAYER) {
                ...
                switch ((didsay = analyse_text_driver(cn, msg->dat1, (char *)msg->dat2, co))) {
                case 2:
                    if (ppd && ppd->brennethbran_state <= 4) {
                        dat->last_talk = 0;
                        ppd->brennethbran_state = 0;
                    }
                    if (ppd && ppd->brennethbran_state >= 5 && ppd->brennethbran_state <= 8) {
                        dat->last_talk = 0;
                        ppd->brennethbran_state = 5;
                    }
                    if (ppd && ppd->brennethbran_state >= 9 && ppd->brennethbran_state <= 11) {
                        dat->last_talk = 0;
                        ppd->brennethbran_state = 9;
                    }
                    if (ppd && ppd->brennethbran_state >= 12 && ppd->brennethbran_state <= 15) {
                        dat->last_talk = 0;
                        ppd->brennethbran_state = 12;
                    }
                    break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Greetings %s, I have watched thee from below here, and have now need for thy strength!", ch[co].name);
                    questlog_open(co, 44);
                    ppd->spiritbran_state++;
                    didsay = 1;
                    break;
                case 1:
                    quiet_say(cn, "Unbeknownst to everyone in Brannington, a Necromancer has revived their ancestors, and is trying to take over the town with his army of undead.");
                    ppd->spiritbran_state++;
                    didsay = 1;
                    break;
                case 2:
                    quiet_say(cn, "If you can retrieve the Brannington Holy Relic which the necromancer has taken, then his army will no longer obey him, and will be trapped here forever.");
                    ppd->spiritbran_state++;
                    didsay = 1;
                    break;
                case 3:
                    quiet_say(cn, "Also, I wish for you to kill this Necromancer. However, in order to get into the crypt, you will have to ask Count Brannington about his jewelry. You will need his help to open the crypt doors.");
                    ppd->spiritbran_state = 4;
                    didsay = 1;
                    break;
                case 4:
                    break; // waiting for holy relic
                case 5:
                    break; // all done
                }
                if (didsay) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Welcome %s, how are you today?", ch[co].name);
                ...
                case 1:
                    ...
                    break;
                case 2:
                    quiet_say(cn, "While I was in the forest, I once overheard the thief mages talking about maps they have hidden on monsters.");
                    ppd->forestbran_state++;
                    didsay = 1;
                    break;
                case 3:
                    quiet_say(cn, "These maps supposedly lead to treasures they have hidden in the forest. If you have one, you can give it to me, and I'll tell you where to dig to find the treasure.");
                    ppd->forestbran_state = 4;
                    didsay = 1;
                    break;
                case 4:
                    break; // waiting for maps
                }
                if (didsay) {
                    dat->last_talk = ticker;
                    talkdir = offset2dx(ch[cn].x, ch[cn].y, ch[co].x, ch[co].y);
        ...
        if (msg->type == NT_TEXT) {
            ...
            if (ch[co].flags & CF_PLAYER) {
                ...
                switch ((didsay = analyse_text_driver(cn, msg->dat1, (char *)msg->dat2, co))) {
                case 2:
                    if (ppd && ppd->forestbran_state <= 4) {
                        dat->last_talk = 0;
                        ppd->forestbran_state = 0;
                    }
                    break;
                case 3:
                    if (ch[co].flags & CF_GOD) {
                        say(cn, "reset done");
                        ppd->forestbran_state = ppd->forestbran_done = 0;
                    }
                    break;
                }
                if (didsay) {
        ...
        if (msg->type == NT_GIVE) {
            ...
            if ((in = ch[cn].citem)) { // we still have it
                ...
                if (it[in].ID == IID_STAFF_FORESTMAP && ppd) {
                    ...
                    case 0:
                        say(cn, "Ah, I see you have brought me a map. Let me see where this one is hidden. hhhmmm... It is beneath a dead tree...");
                        break;
                    case 1:
                        say(cn, "Ah, I see you have brought me a map. Let me see where this one is hidden. hhhmmm... It is under the heat of a fire...");
                        break;
                    case 2:
                        say(cn, "Ah, I see you have brought me a map. Let me see where this one is hidden. hhhmmm... It is next to an empty bucket...");
                        break;
                    case 3:
                        say(cn, "Ah, I see you have brought me a map. Let me see where this one is hidden. hhhmmm... It is inside a circle of stones...");
                        break;
                    case 4:
                        say(cn, "Ah, I see you have brought me a map. Let me see where this one is hidden. hhhmmm... It is next to a pair of bags...");
                        break;
                    case 5:
                        say(cn, "This is the first map again, I'm afraid. I think you've found all the treasures.");
                        break;
                    }
                } else {
                    quiet_say(cn, "Thou hast better use for this than I do. Well, if there is use for it at all.");
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    if (ppd->countbran_state == 0) quiet_say(cn, "Greetings stranger, welcome to the town of Brannington. If you will, the Count would like to ask for your services. We have already informed him of your arrival, and you can find him in the mansion at the end of this street.");
                    ppd->guardbran_state++;
                    didsay = 1;
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    quiet_say(cn, "My cousin is a scout for the Count, and last night he came back in a most desperate state. He rambled about having met someone up in the mountains above the mines.");
                    ppd->guardbran_state++;
                    didsay = 1;
                    break;
                case 4:
                    ...
                    break;
                case 5:
                    quiet_say(cn, "Your mission, %s is to find out who is up there, and if they are friendly or hostile.", get_army_rank_string(co));
                    ppd->guardbran_state++;
                    didsay = 1;
                    questlog_open(co, 64);
                    break;
        ...
        if (msg->type == NT_TEXT) {
            ...
            if (ch[co].flags & CF_PLAYER) {
                ...
                switch ((didsay = analyse_text_driver(cn, msg->dat1, (char *)msg->dat2, co))) {
                case 2:
                    if (ppd && ppd->guardbran_state <= 1) {
                        dat->last_talk = 0;
                        ppd->guardbran_state = 0;
                    }
                    if (ppd && ppd->guardbran_state >= 2 && ppd->guardbran_state <= 6) {
                        dat->last_talk = 0;
                        ppd->guardbran_state = 2;
                    }
                    if (ppd && ppd->guardbran_state >= 7 && ppd->guardbran_state <= 8) {
                        dat->last_talk = 0;
                        ppd->guardbran_state = 7;
                    }
                    break;
                }
                if (didsay) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Greetings stranger! I am Broklin, the Chief Miner. I supply the town with all its plating materials.");
                    questlog_open(co, 45);
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 1:
                    quiet_say(cn, "Well, I did before those damnable robbers broke into my house and stole my favorite pickaxe.");
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    break; // waiting for pickaxe

                case 5:
                    if (questlog_isdone(co, 46)) {
                    ...
                    break;
                case 6:
                    quiet_say(cn, "The robbers infest this city...perhaps you could kill the head robber.");
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 7:
                    quiet_say(cn, "I hear his whereabouts is a great secret, but maybe you could find him.");
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 8:
                    if (!has_item(co, IID_STAFF_SEWERKEY)) {
                    ...
                    break;
                case 9:
                    quiet_say(cn, "You can begin your search there!");
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 10:
                    break; // waiting player to kill robber's head

                case 11:
                    quiet_say(cn, "If you ever have need of silver or gold for plating, I can offer reasonable trade rates.");
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 12:
                    quiet_say(cn, "I can offer 2,000 gold units for 5,000 silver units.");
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 13:
                    quiet_say(cn, "Or, I can offer 2,500 silver units for 1,000 gold units.");
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 14:
                    ...
                    break;
                case 15:
                    break; // waiting for repeat :P
                case 16:
                    quiet_say(cn, "Hail %s! Nice to see you again.", ch[co].name);
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 17:
        ...
        if (msg->type == NT_TEXT) {
            ...
            if (ch[co].flags & CF_PLAYER) {
                ...
                switch ((didsay = analyse_text_driver(cn, msg->dat1, (char *)msg->dat2, co))) {
                case 2:
                    if (ppd && ppd->broklin_state >= 0 && ppd->broklin_state <= 4) {
                        dat->last_talk = 0;
                        ppd->broklin_state = 0;
                    }
                    if (ppd && ppd->broklin_state >= 5 && ppd->broklin_state <= 10) {
                        dat->last_talk = 0;
                        ppd->broklin_state = 5;
                    }
                    if (ppd && ppd->broklin_state >= 11 && ppd->broklin_state <= 19) {
                        dat->last_talk = 0;
                        ppd->broklin_state = 16;
                    }
                    break;
                case 3:
                    if (ch[co].flags & CF_GOD) {
                    ...
                    break;
                case 4:
                    broklin_trade_gold(cn, co);
                    break;
                case 5:
                    broklin_trade_silver(cn, co);
                    break;
                }
                if (didsay) {
                    talkdir = offset2dx(ch[cn].x, ch[cn].y, ch[co].x, ch[co].y);
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 3:
                    quiet_say(cn, "Didn't I tell you it was worth it? Oh, all that knowledge just makes the mind grow! Isn't Shanra wonderful? She can tell so many stories, more even than those books of her can...");
                    ppd->grinnich_state++;
                    didsay = 1;
                    break;
                case 4:
        ...
        if (msg->type == NT_TEXT) {
            ...
            if (ch[co].flags & CF_PLAYER) {
                ...
                switch ((didsay = analyse_text_driver(cn, msg->dat1, (char *)msg->dat2, co))) {
                case 2:
                    if (ppd && ppd->grinnich_state <= 2) {
                        dat->last_talk = 0;
                        ppd->grinnich_state = 0;
                    }
                    if (ppd && ppd->grinnich_state >= 3 && ppd->grinnich_state <= 4) {
                        dat->last_talk = 0;
                        ppd->grinnich_state = 3;
                    }
                    break;
                case 3:
                    if (ch[co].flags & CF_GOD) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Welcome adventurer, Grinnich told me you were coming. You have made it through my tower, and so I will reward you. You will have to work your way through some sentinels to find the Grimoire of Animation");
                    ppd->shanra_state++;
                    didsay = 1;
                    break;
                case 1:
                ...
                case 2:
                    break;
                case 3:
                    quiet_say(cn, "Well done! It is good to see others learning about animation. I can't teach you how to use it though, the magic is ancient, and takes a long time to learn and control. I will now send you back to the ruins above.");
                    ppd->shanra_state++;
                    didsay = 1;
                    break;
                case 4:
                    teleport_char_driver(co, 53, 129);
                    ppd->shanra_state++;
                    didsay = 1;
                    break;
                case 5:
        ...
        if (msg->type == NT_TEXT) {
            ...
            if (ch[co].flags & CF_PLAYER) {
                ...
                switch ((didsay = analyse_text_driver(cn, msg->dat1, (char *)msg->dat2, co))) {
                case 2:
                    if (ppd && ppd->shanra_state <= 2) {
                        dat->last_talk = 0;
                        ppd->shanra_state = 0;
                    }
                    if (ppd && ppd->shanra_state >= 3 && ppd->shanra_state <= 5) {
                        dat->last_talk = 0;
                        ppd->shanra_state = 3;
                    }
                    break;
...
void centinel_dead(int cn, int co) {
    ...
    case 1:
        log_char(co, LOG_SYSTEM, 0, "You have killed the first sentinel on this floor, kill 29 more!");
        break;
    case 10:
        log_char(co, LOG_SYSTEM, 0, "You have killed 10 sentinels, 20 more to go!");
        break;
    case 20:
        log_char(co, LOG_SYSTEM, 0, "You have killed 20 sentinels, 10 more to go!");
        break;
    case 30:
        log_char(co, LOG_SYSTEM, 0, "Congratulations, you have killed 30 sentinels! Continue your journey.");
...
int ch_driver(int nr, int cn, int ret, int lastact) {
    switch (nr) {
    case CDR_COUNTBRAN:
        count_brannington_driver(cn, ret, lastact);
        return 1;
    case CDR_COUNTESSABRAN:
        countessa_brannington_driver(cn, ret, lastact);
        return 1;
    case CDR_DAUGHTERBRAN:
        daughter_brannington_driver(cn, ret, lastact);
        return 1;
    case CDR_SPIRITBRAN:
        spirit_brannington_driver(cn, ret, lastact);
        return 1;
    case CDR_GUARDBRAN:
        guard_brannington_driver(cn, ret, lastact);
        return 1;
    case CDR_BRENNETHBRAN:
        brenneth_brannington_driver(cn, ret, lastact);
        return 1;
    case CDR_FORESTBRAN:
        forest_brannington_driver(cn, ret, lastact);
        return 1;
    case CDR_BROKLIN:
        broklin_driver(cn, ret, lastact);
        return 1;
    case CDR_GRINNICH:
        grinnich_driver(cn, ret, lastact);
        return 1;
    case CDR_SHANRA:
        shanra_driver(cn, ret, lastact);
        return 1;
    case CDR_CENTINEL:
