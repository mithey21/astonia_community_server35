...
int build_enemy(int x, int y, int level) {
    ...
    in = create_item("armor_spell_med");
    ch[cn].item[14] = in;
    it[in].carried = cn;
...
int build_junk(int x, int y, int level) {
    ...
    if (!set_item_map(in, x + RANDOM(3), y + RANDOM(3))) {
        destroy_item(in);
        return 0;
    }
...
void build_shrine(int x, int y, int level) {
    ...
    switch (level) {
    case 10:
        build_shrine_sub(x, y, level, 54, "Shrine of Security", 59399);
        break;
    case 11:
        build_shrine_sub(x, y, level, 1, "Shrine of Indecisiveness", 59392);
        break;
    case 12:
        build_shrine_sub(x, y, level, 73, "Shrine of Welding", 59394);
        break;
    case 13:
        build_shrine_sub(x, y, level, 31, "Shrine of Living on the Edge", 59395);
        break;
    case 14:
        break;
    case 15:
        build_shrine_sub(x, y, level, 11, "Shrine of Bribes", 59393);
        break;
    case 16:
        break;
    case 17:
        break;
    case 18:
        build_shrine_sub(x, y, level, 21, "Shrine of Welding", 59394);
        break;
    case 19:
        break;
    case 20:
        build_shrine_sub(x, y, level, 64, "Shrine of the Jobless", 59400);
        break;
    case 21:
        break; //build_shrine_sub(x,y,level,41,"Shrine of Kindness",59396); break;
    case 22:
        build_shrine_sub(x, y, level, 12, "Shrine of Bribes", 59393);
        break;
    case 23:
        break;
    case 24:
        build_shrine_sub(x, y, level, 2, "Shrine of Indecisiveness", 59392);
        break;
    case 25:
        build_shrine_sub(x, y, level, 74, "Shrine of Welding", 59394);
        break;
    case 26:
        build_shrine_sub(x, y, level, 32, "Shrine of Living on the Edge", 59395);
        break;
    case 27:
        build_shrine_sub(x, y, level, 22, "Shrine of Welding", 59394);
        break;
    case 28:
        break;
    case 29:
        build_shrine_sub(x, y, level, 55, "Shrine of Security", 59399);
        break;
    case 30:
        build_shrine_sub(x, y, level, 50, "Shrine of Vitality", 59397);
        break;
    case 31:
        break;
    case 32:
        build_shrine_sub(x, y, level, 23, "Shrine of Welding", 59394);
        break;
    case 33:
        break;
    case 34:
        build_shrine_sub(x, y, level, 13, "Shrine of Bribes", 59393);
        break;
    case 35:
        build_shrine_sub(x, y, level, 75, "Shrine of Welding", 59394);
        break;
    case 36:
        build_shrine_sub(x, y, level, 33, "Shrine of Living on the Edge", 59395);
        break;
    case 37:
        build_shrine_death(x, y, level);
        break;
    case 38:
        build_shrine_sub(x, y, level, 3, "Shrine of Indecisiveness", 59392);
        break;
    case 39:
        break;
    case 40:
        break;
    case 41:
        build_shrine_sub(x, y, level, 56, "Shrine of Security", 59399);
        break;
    case 42:
        build_shrine_sub(x, y, level, 34, "Shrine of Living on the Edge", 59395);
        break;
    case 43:
        build_shrine_sub(x, y, level, 4, "Shrine of Indecisiveness", 59392);
        break;
    case 44:
        build_shrine_sub(x, y, level, 76, "Shrine of Welding", 59394);
        break;
    case 45:
        build_shrine_sub(x, y, level, 65, "Shrine of the Jobless", 59401);
        break;
    case 46:
        build_shrine_sub(x, y, level, 24, "Shrine of Welding", 59394);
        break;
    case 47:
        break;
    case 48:
        build_shrine_sub(x, y, level, 14, "Shrine of Bribes", 59393);
        break;
    case 49:
        break;
    case 50:
        break;
    case 51:
        build_shrine_sub(x, y, level, 52, "Shrine of Braveness", 59398);
        break;
    case 52:
        build_shrine_sub(x, y, level, 25, "Shrine of Welding", 59394);
        break;
    case 53:
        break;
    case 54:
        build_shrine_sub(x, y, level, 15, "Shrine of Bribes", 59393);
        break;
    case 55:
        break; //build_shrine_sub(x,y,level,42,"Shrine of Kindness",59396); break;
    case 56:
        build_shrine_sub(x, y, level, 77, "Shrine of Welding", 59394);
        break;
    case 57:
        build_shrine_sub(x, y, level, 5, "Shrine of Indecisiveness", 59392);
        break;
    case 58:
        build_shrine_sub(x, y, level, 57, "Shrine of Security", 59399);
        break;
    case 59:
        build_shrine_sub(x, y, level, 35, "Shrine of Living on the Edge", 59395);
        break;
    case 60:
        break;
    case 61:
        build_shrine_sub(x, y, level, 66, "Shrine of the Jobless", 59401);
        break;
    case 62:
        build_shrine_sub(x, y, level, 26, "Shrine of Welding", 59394);
        break;
    case 63:
        break;
    case 64:
        build_shrine_sub(x, y, level, 6, "Shrine of Indecisiveness", 59392);
        break;
    case 65:
        build_shrine_sub(x, y, level, 78, "Shrine of Welding", 59394);
        break;
    case 66:
        build_shrine_sub(x, y, level, 36, "Shrine of Living on the Edge", 59395);
        break;
    case 67:
        build_shrine_sub(x, y, level, 16, "Shrine of Bribes", 59393);
        break;
    case 68:
        break;
    case 69:
        build_shrine_sub(x, y, level, 58, "Shrine of Security", 59399);
        break;
    case 70:
        break;
    case 71:
        break;
    case 72:
        build_shrine_sub(x, y, level, 27, "Shrine of Welding", 59394);
        break;
    case 73:
        break;
    case 74:
        build_shrine_sub(x, y, level, 37, "Shrine of Living on the Edge", 59395);
        break;
    case 75:
        build_shrine_sub(x, y, level, 59, "Shrine of Security", 59399);
        break;
    case 76:
        build_shrine_sub(x, y, level, 7, "Shrine of Indecisiveness", 59392);
        break;
    case 77:
        build_shrine_sub(x, y, level, 79, "Shrine of Welding", 59394);
        break;
    case 78:
        build_shrine_sub(x, y, level, 17, "Shrine of Bribes", 59393);
        break;
    case 79:
        break;
    case 80:
        break;
    case 81:
        build_shrine_sub(x, y, level, 28, "Shrine of Welding", 59394);
        break;
    case 82:
        build_shrine_sub(x, y, level, 67, "Shrine of the Jobless", 59401);
        break;
    case 83:
        build_shrine_sub(x, y, level, 8, "Shrine of Indecisiveness", 59392);
        break;
    case 84:
        break;
    case 85:
        build_shrine_sub(x, y, level, 60, "Shrine of Security", 59399);
        break;
    case 86:
        build_shrine_sub(x, y, level, 18, "Shrine of Bribes", 59393);
        break;
    case 87:
        break;
    case 88:
        build_shrine_sub(x, y, level, 38, "Shrine of Living on the Edge", 59395);
        break;
    case 89:
        build_shrine_sub(x, y, level, 80, "Shrine of Welding", 59394);
        break;
    case 90:
        break;
    case 91:
        build_shrine_sub(x, y, level, 39, "Shrine of Living on the Edge", 59395);
        break;
    case 92:
        break;
    case 93:
        build_shrine_sub(x, y, level, 19, "Shrine of Bribes", 59393);
        break;
    case 94:
        build_shrine_sub(x, y, level, 61, "Shrine of Security", 59399);
        break;
    case 95:
        build_shrine_sub(x, y, level, 81, "Shrine of Welding", 59394);
        break;
    case 96:
        build_shrine_sub(x, y, level, 9, "Shrine of Indecisiveness", 59392);
        break;
    case 97:
        build_shrine_sub(x, y, level, 68, "Shrine of the Jobless", 59401);
        break;
    case 98:
        build_shrine_sub(x, y, level, 29, "Shrine of Welding", 59394);
        break;
    case 99:
        break;
    }
...
void build_cell(int cx, int cy, struct cell *cell) {
    ...
    switch (cell->special) {
    case 3:
        build_enemy(cx * 4 + xoff + 2, cy * 4 + yoff + 2, maze_level);
        break;
    case 4:
        build_junk(cx * 4 + xoff + 1, cy * 4 + yoff + 1, maze_level);
        break;
    case 5:
        build_gastrap1(cx * 4 + xoff + 1, cy * 4 + yoff + 1, maze_level);
        break;
    case 6:
        build_gastrap2(cx * 4 + xoff + 1, cy * 4 + yoff + 1, maze_level);
        break;
    case 7:
        build_trapdoor1(cx * 4 + xoff + 1, cy * 4 + yoff + 1, maze_level);
        break;
    case 8:
        build_trapdoor2(cx * 4 + xoff + 1, cy * 4 + yoff + 1, maze_level);
        break;
    case 9:
        build_shrine_continuity(cx * 4 + xoff + 2, cy * 4 + yoff + 2, maze_level);
        break;
    case 10:
        build_shrine(cx * 4 + xoff + 2, cy * 4 + yoff + 2, maze_level);
        break;
    }
}
...
void build_maze(struct cell *cell) {
    ...
    stack = xcalloc(sizeof(int) * xsize * ysize, IM_TEMP);
    ptr = 0;
...
int create_maze(int base, int level, int show) {
    ...
    while (panic--) {
        ...
        if (cell[m].t && cell[m].l && cell[m + xsize].t) {
            cell[m].special = 9;
            break;
        }
    }
...
void create_dungeon(int cn, int co, int level, struct master_data *dat) {
    ...
    for (n = 0; n < 16; n++) {
        if (dat->created[n]) tmp = ticker - dat->created[n];
        else tmp = max(DUNGEONTIME, ticker - dat->created[n]);
        if (tmp > best) {
            best = tmp;
            bestn = n;
        }
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 3:
                ...
                break;
            case 4:
                if (ch[co].flags & CF_GOD) del_data(co, DRD_RANDOMSHRINE_PPD);
                break;
            }
...
void shrine_bribes(int in, int cn, int nr, int level, struct shrine_ppd *ppd) {
    ...
    want = level_value(level) / 3;
    need = level_value(level) / 10;
...
int can_give_mod(int in) {
    ...
    for (n = 0; n < MAXMOD; n++) {
        if (!it[in].mod_value[n]) continue;
        if (it[in].mod_index[n] < 0) continue;
...
void shrine_welding(int in, int cn, int nr, int level, struct shrine_ppd *ppd) {
    ...
    for (n = cnt = 0; n < 12; n++) {
        if ((tmp = ch[cn].item[n]) && tmp != in2 && can_receive_mod(tmp)) cnt++;
    }
    if (!cnt) {
    ...
    for (n = 0; n < 12; n++) {
        if ((tmp = ch[cn].item[n]) && tmp != in2 && (in1 = can_receive_mod(tmp)) && !cnt--) break;
    }
    ...
    n = m = 0;
    while (n < MAXMOD && m < MAXMOD) {
        v = it[in1].mod_index[n];
        if (v == V_ARMOR) {
            n++;
            continue;
        }
        ...
        if (it[in1].mod_value[n] < 0) {
            n++;
            continue;
        }

        v = it[in2].mod_index[m];
        if (v == V_ARMOR) {
            m++;
            continue;
        }
        ...
        if (it[in2].mod_value[m] < 0) {
            m++;
            continue;
        }

        tmp = it[in1].mod_index[n];
        it[in1].mod_index[n] = it[in2].mod_index[m];
        it[in2].mod_index[m] = tmp;

        tmp = it[in1].mod_value[n];
        it[in1].mod_value[n] = it[in2].mod_value[m];
        it[in2].mod_value[m] = tmp;
...
void shrine_edge(int in, int cn, int nr, int level, struct shrine_ppd *ppd) {
    ...
    bonus = level_value(level) / 3 + ch[cn].saves * level_value(level) / 10;
...
void shrine_vitality(int in, int cn, int nr, int level, struct shrine_ppd *ppd) {
    ...
    if (ch[cn].flags & CF_WARRIOR) v = V_HP;
    else v = V_MANA;

    if (ch[cn].flags & CF_ARCH) cnt = min(5, 100 - ch[cn].value[1][v]);
    else cnt = min(5, 50 - ch[cn].value[1][v]);
    ...
    log_char(cn, LOG_SYSTEM, 0, "A lively voice says: 'Thy vitality was increased by %d.'", cnt);
...
void randomshrine(int in, int cn) {
    ...
    case 8:
    case 9:
        if (shrine_check(cn, it[in].drdata[0], ppd))
    ...
    case 254:
        break;
    case 255:
        shrine_continuity(in, cn, it[in].drdata[0], it[in].drdata[1], ppd);
        break;

    default:
        elog("item %s at %d,%d: unknown type %d", it[in].name, it[in].x, it[in].y, it[in].drdata[0]);
    }
}
...
void junkpile(int in, int cn) {
    ...
    switch (RANDOM(10)) {
    case 1:
        in2 = create_item("steelbar");
        break;
    case 2:
        in2 = create_item("steelbar");
        break;
    case 3:
        in2 = create_money_item(RANDOM(100 * level) + level);
        break;
    case 4:
        in2 = create_item("steelbar");
        break;
...
int ch_driver(int nr, int cn, int ret, int lastact) {
    switch (nr) {
    case CDR_RANDOMMASTER:
        randommaster(cn, ret, lastact);
        return 1;
