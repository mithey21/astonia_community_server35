    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Welcome %s! I am %s the Mage.", ch[co].name, ch[cn].name);
                    questlog_open(co, 1);
                    ppd->gwendy_state = 1;
                    didsay = 1;
                    break;
                case 1:
                    quiet_say(cn, "South-east of my tower lies an old ruin. 'Tis inhabitated by skeletons, raised by some evil magic.");
                    ppd->gwendy_state = 2;
                    didsay = 1;
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    quiet_say(cn, "It could be anything: An enhanced bone, an ancient jewel, even a magical spoon of doom.");
                    ppd->gwendy_state = 4;
                    didsay = 1;
                    break;
                case 4:
                    quiet_say(cn, "If thou couldst find it and bring it to me, I would reward thee.");
                    ppd->gwendy_state = 5;
                    didsay = 1;
                    break;
                case 5:
                    if (realtime - ppd->gwendy_seen_timer > 60) {
                        quiet_say(cn, "Be greeted, %s! Didst thou find anything magical in the skeleton's ruin? Or dost thou want me to \260c4repeat\260c0 mine offer?", ch[co].name);
                        notify_area(ch[cn].x, ch[cn].y, NT_NPC, NTID_TUTORIAL, 1, co);
                        didsay = 1;
                    }
                    break;
                case 6:
                    if (questlog_isdone(co, 2)) {
                        ppd->gwendy_state = 10;
                        break;
                    }
                ...
                case 9:
                    if (realtime - ppd->gwendy_seen_timer > 60) {
                        quiet_say(cn, "Be greeted, %s! Didst thou find anything magical in the other skeleton place? Or dost thou want me to \260c4repeat\260c0 mine offer?", ch[co].name);
                        didsay = 1;
                    }
                    break;
                case 10:
                    if (questlog_isdone(co, 3)) {
                        ppd->gwendy_state = 13;
                        break;
                    }
                    ...
                    break;
                case 11:
                    quiet_say(cn, "Oh, if thou couldst find it, %s, I would be very grateful. Pray thee %s, locate this skull and bring it to me.", ch[co].name, ch[co].name);
                    ppd->gwendy_state++;
                    didsay = 1;
                    break;
                case 12:
                    if (realtime - ppd->gwendy_seen_timer > 60) {
                        quiet_say(cn, "Ah, %s! Didst thou find the skull? It really is of the utmost importance. Or dost thou want me to \260c4repeat\260c0  mine offer?", ch[co].name);
                        didsay = 1;
                    }
                    break;
                case 13:
                    if (questlog_isdone(co, 4)) {
                        ppd->gwendy_state = 17;
                        break;
                    }
                    ...
                    break;
                case 14:
                    quiet_say(cn, "But I know every room in here. How can this be? Thou hast been most clever so far, %s. If thou couldst search the tower?", ch[co].name);
                    ppd->gwendy_state++;
                    didsay = 1;
                    break;
                case 15:
                ...
                case 16:
                    if (realtime - ppd->gwendy_seen_timer > 60) {
                        quiet_say(cn, "Ah, %s! I am most concerned. Didst thou find anything? Or dost thou want me to \260c4repeat\260c0  what I said about it?", ch[co].name);
                        didsay = 1;
                    }
                    break;
                case 17:
                    quiet_say(cn, "I do not have any more work for thee, %s.", ch[co].name);
                    ppd->gwendy_state++;
                    didsay = 1;
                    break;
                case 18:
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_AREA1_PPD, sizeof(struct area1_ppd));
                if (ppd && ppd->gwendy_state <= 5) {
                    dat->last_talk = 0;
                    ppd->gwendy_state = 1;
                }
                if (ppd && ppd->gwendy_state >= 6 && ppd->gwendy_state <= 9) {
                    dat->last_talk = 0;
                    ppd->gwendy_state = 6;
                }
                if (ppd && ppd->gwendy_state >= 10 && ppd->gwendy_state <= 12) {
                    dat->last_talk = 0;
                    ppd->gwendy_state = 10;
                }
                if (ppd && ppd->gwendy_state >= 13 && ppd->gwendy_state <= 16) {
                    dat->last_talk = 0;
                    ppd->gwendy_state = 13;
                }
                if (ppd && ppd->gwendy_state >= 17) {
                    dat->last_talk = 0;
                    ppd->gwendy_state = 17;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Hail %s! I am %s, the hunter.", ch[co].name, ch[cn].name);
                    ppd->yoakin_state = 1;
                    didsay = 1;
                    break;
                case 1:
                    quiet_say(cn, "Be careful in the forest around the village, %s. There are wolves and bears about which can be very aggressive.", ch[co].name);
                    ppd->yoakin_state = 2;
                    didsay = 1;
                    break;
                case 2:
                    if (ppd->logain_state < 6) break; // dont give out quest before mad knights is done
                ...
                case 3:
                    ...
                    break;
                case 4:
                    if (realtime - ppd->yoakin_seen_timer > 60) {
                        quiet_say(cn, "Hail, %s! Didst thou find that big bear? Or dost thou want me to \260c4repeat\260c0 mine offer?", ch[co].name);
                        didsay = 1;
                    }
                    break;
                case 5:
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    if (ppd->gwendy_state < 6) break; // dont offer skelly stories before skull 2
                ...
                case 1:
                    ...
                    break;
                case 2:
                    quiet_say(cn, "Some of the lads from the village went looking for them, but had no luck. Or they were lucky, depends on the way thou lookst at it I guess.");
                ...
                case 7:
                    ...
                    break;
                case 8:
                    quiet_say(cn, "And those skeletons all around... We live in hard times.");
                    ppd->terion_state++;
                    didsay = 1;
                    break;
                ...
                case 9:
                    ...
                    break;
                case 10:
                    quiet_say(cn, "Undeads and strange beasts and even demons have been seen in Aston. Didst thou know that?");
                    ppd->terion_state++;
                    didsay = 1;
                    break;
                case 11:
                    quiet_say(cn, "Some years ago those monsters attacked our capital and killed our emperor. Most of his honor guard, the Seyan'Du, died in his defense, but to no avail. With the emperor dead, and the imperial palace in ruins, there was no one to organize our defenses.");
                    ppd->terion_state++;
                    didsay = 1;
                    break;
                case 12:
                    quiet_say(cn, "And so the dark hordes are spreading all over the land.");
                    ppd->terion_state++;
                    didsay = 1;
                    break;
                case 13:
        ...
        if (msg->type == NT_TEXT) {
            ...
            switch ((didsay = analyse_text_driver(cn, msg->dat1, (char *)msg->dat2, co))) {
            case 2:
                if (ppd && ppd->terion_state <= 4) {
                    dat->last_talk = 0;
                    ppd->terion_state = 0;
                }
                if (ppd && ppd->terion_state >= 5 && ppd->terion_state <= 6) {
                    dat->last_talk = 0;
                    ppd->terion_state = 4;
                }
                if (ppd && ppd->terion_state >= 7 && ppd->terion_state <= 9) {
                    dat->last_talk = 0;
                    ppd->terion_state = 6;
                }
                if (ppd && ppd->terion_state >= 10 && ppd->terion_state <= 14) {
                    dat->last_talk = 0;
                    ppd->terion_state = 9;
                }
                break;
...
void james_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    quiet_say(cn, "I cannot remember how I came back here, and if Lydia got home safely. So couldst thou visit Lydia and give her my regards and inquire about her health?");
                    ppd->james_state++;
                    didsay = 1;
                    break;
                case 2:
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_AREA1_PPD, sizeof(struct area1_ppd));
                if (ppd && ppd->james_state >= 0 && ppd->james_state <= 3) {
                    ppd->james_state = 0;
                    dat->last_talk = 0;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Hullo, %s. I am %s, the judge.", ch[co].name, ch[cn].name);
                    ppd->nook_state++;
                    didsay = 1;
                    break;
                case 1:
                    quiet_say(cn, "Oh, wait. I am %s, the Knight of the Shining Armor.", ch[cn].name);
                    ppd->nook_state++;
                    didsay = 1;
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    quiet_say(cn, "If thou art looking for Gwendylon, the mage, take the northernmost door. If thou wishest to talk to Lydia, his noble mageness' daughter, take this door.");
                    ppd->nook_state++;
                    didsay = 1;
                    break;
                case 4:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    quiet_say(cn, "I could never make anything of it, but maybe thou art wise enough to understand it, %s.", ch[co].name);
                    ppd->nook_state++;
                    didsay = 1;
                    break;
                case 8:
                    ...
                    break;
                case 9:
                    quiet_say(cn, "Now these robbers are demanding a ransom for that cap. But alas, I am poor and cannot pay. I am to meet that robber at midnight behind the 'Brotherhood of Knights', and I was hoping that thou couldst go there, hide, and follow that robber to his hideout and rescue my cap.");
                    ppd->nook_state++;
                    didsay = 1;
                    break;
                case 10:
                ...
                case 12:
                    ...
                    break;
                case 13:
                    quiet_say(cn, "The entrance is behind Yoakin's house, close to the ruin.");
                    ppd->nook_state++;
                    didsay = 1;
                    break;
                case 14:
                    quiet_say(cn, "When I started working here, before Gwendylon bought the tower, the old owner - he was a bit strange - used to murmur: 'Stand between torches, in the courtyard, stand between torches'.");
                    ppd->nook_state++;
                    didsay = 1;
                    break;
                case 15:
                    break; // repeat of yoakin/torches hint still possible
                case 16:
                    break; // all gwendy quests done
                }
                if (didsay) {
                    dat->last_talk = ticker;
                    talkdir = offset2dx(ch[cn].x, ch[cn].y, ch[co].x, ch[co].y);
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_AREA1_PPD, sizeof(struct area1_ppd));
                if (ppd && ppd->nook_state <= 4) {
                    dat->last_talk = 0;
                    ppd->nook_state = 0;
                }
                if (ppd && ppd->nook_state >= 5 && ppd->nook_state <= 11) {
                    dat->last_talk = 0;
                    ppd->nook_state = 5;
                }
                if (ppd && ppd->nook_state >= 12 && ppd->nook_state <= 15) {
                    dat->last_talk = 0;
                    ppd->nook_state = 12;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    quiet_say(cn, "Oohh, my head. Hu? Ah, hello %s. I am %s.", ch[co].name, ch[cn].name);
                    ppd->lydia_state++;
                    didsay = 1;
                    questlog_open(co, 0);
                    break;
                case 1:
                    quiet_say(cn, "I am sorry, I am no good company today. I went to a party in the village last night and now I got a horrible headache. I had a potion with me which should help cure the hangover.");
                    ppd->lydia_state++;
                    didsay = 1;
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    quiet_say(cn, "I would be grateful indeed. My head is killing me. They ambushed me right here in front of the tower and fled west with their loot.");
                    ppd->lydia_state++;
                    didsay = 1;
                    break;
                case 4:
                    if (realtime - ppd->lydia_seen_timer > 60) {
                        quiet_say(cn, "Hello again, %s! Didst thou find the potion? Or dost thou want me to \260c4repeat\260c0 mine offer?", ch[co].name);
                        didsay = 1;
                        notify_area(ch[cn].x, ch[cn].y, NT_NPC, NTID_TUTORIAL, 0, co);
                    }
                    break;
                case 5:
                    quiet_say(cn, "Here, this might save thy life.");
                    ppd->lydia_state++;
                    didsay = 1;
                    break;
                case 6:
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_AREA1_PPD, sizeof(struct area1_ppd));
                if (ppd && ppd->lydia_state <= 4) {
                    dat->last_talk = 0;
                    ppd->lydia_state = 1;
                }
                if (ppd && ppd->lydia_state >= 6 && ppd->lydia_state <= 7) {
                    dat->last_talk = 0;
                    ppd->lydia_state = 6;
                }
                break;
...
void robber_driver(int cn, int ret, int lastact) {
    ...
    switch (dat->state) {
    case 0:
        if (secure_move_driver(cn, 30, 242, DX_UP, ret, lastact)) return;
        if (hour == 23 && minute > 45) dat->state++;
        break;

    case 1:
        if (move_driver(cn, 30, 237, 1)) return;
        dat->state++;
        break;
    case 2:
        in = map[31 + 237 * MAXMAP].it;
        if (!in) {
            charlog(cn, "my ladder is gone!");
            dat->state = 0;
            break;
        }
        ...
        break;
    case 3:
        if (move_driver(cn, 222, 78, 1)) return;
        dat->state++;
        break;
    case 4:
        if (move_driver(cn, 190, 78, 1)) return;
        dat->state++;
        break;
    case 5:
        if (move_driver(cn, 173, 78, 1)) return;
        dat->state++;
        break;
    case 6:
        if (move_driver(cn, 173, 54, 1)) return;
        dat->state++;
        break;
    case 7:
        if (move_driver(cn, 145, 54, 1)) return;
        dat->state++;
        break;
    case 8:
        if (move_driver(cn, 145, 72, 1)) return;
    ...
    case 14:
        ...
        break;
    case 15:
        in = map[244 + 78 * MAXMAP].it;
        if (!in) {
            charlog(cn, "my hole is gone!");
            dat->state = 0;
            break;
        }
        if (use_driver(cn, in, 0)) return;
...
void sanoa_driver(int cn, int ret, int lastact) {
    ...
    switch (dat->state) {
    case 0:
        if (secure_move_driver(cn, 16, 31, DX_RIGHT, ret, lastact)) return;
    ...
    case 1:
        if (move_driver(cn, 21, 31, 1)) return;
        dat->state++;
        break;
    case 2:
        if (move_driver(cn, 21, 25, 0)) return;
        dat->state++;
        break;
    case 3:
        if (!is_closed(21, 26) && use_item_at(cn, 21, 26, 0)) return;
        dat->state++;
        break;
    case 4:
        if (move_driver(cn, 21, 23, 1)) return;
        dat->state++;
        break;
    case 5:
        if (move_driver(cn, 69, 23, 1)) return;
        dat->state++;
        break;
    case 6:
        if (move_driver(cn, 69, 42, 1)) return;
    ...
    case 8:
        ...
        break;
    case 9:
        if (move_driver(cn, 21, 27, 0)) return;
        dat->state++;
        break;
    case 10:
        if (!is_closed(21, 26) && use_item_at(cn, 21, 26, 0)) return;
...
void reskin_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if (realtime - ppd->reskin_seen_timer > 600) {
                        quiet_say(cn, "Hello again, %s! Didst thou find any new ingredients? Or dost thou want me to \260c4repeat\260c0 mine offer?", ch[co].name);
                        didsay = 1;
                ...
                case 5:
                    ...
                    break;
                case 6:
                    quiet_say(cn, "Thou canst find them by going through that fake wall there, in the western corner of the room, between these two barrels.");
                    ppd->reskin_state++;
                    didsay = 1;
                    break;
                case 7:
                    ...
                    break;
                case 8:
                    if (ch[co].flags & CF_WARRIOR) quiet_say(cn, "Thou canst make a potion to raise thine abilities by using Adygalah, Chrysado, Domari, Beelough and any mushroom.");
        ...
        if (msg->type == NT_TEXT) {
            ...
            switch ((didsay = analyse_text_driver(cn, msg->dat1, (char *)msg->dat2, co))) {
            case 2:
                if (ppd && ppd->reskin_state <= 4) {
                    dat->last_talk = 0;
                    ppd->reskin_state = 0;
                }
                if (ppd && ppd->reskin_state >= 4 && ppd->reskin_state <= 7) {
                    dat->last_talk = 0;
                    ppd->reskin_state = 4;
                }
                if (ppd && ppd->reskin_state >= 8 && ppd->reskin_state <= 9) {
                    dat->last_talk = 0;
                    ppd->reskin_state = 8;
                }
                break;
                ...
                if (it[in].ID == IID_ALCHEMY_INGREDIENT) { // alchemy ingredient
                    if (!(ppd->reskin_got_bits & (bit = (1 << it[in].drdata[0])))) {
                        ...
                        if (it[in].drdata[0] == 24 && ch[co].level < 80) { // earth stone
                            ...
                            stats_update(co, 0, it[in].value * 5);
        ...
        if (msg->type == NT_CHAR) {
            ...
            if ((ch[co].flags & CF_PLAYER) &&
                ...
                if (ch[co].x < 115) {
                    ...
                    case 0:
                        quiet_say(cn, "Hello %s. These rooms are private. Please go back.", ch[co].name);
                        ppd->asturin_state++;
                        break;
                    case 4:
                        quiet_say(cn, "Hello %s. These rooms are private. Please go back.", ch[co].name);
                        ...
                        break;
                    case 7:
                        quiet_say(cn, "Be greeted, %s. Welcome.", ch[co].name);
                        ppd->asturin_state++;
                        break;
                    }
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    if (ppd->gwendy_state < 17) break; // dont offer quest before skull 1-4 are done
                ...
                case 1:
                    ...
                    break;
                case 2:
                    quiet_say(cn, "I used to teach at the Order of Mages. That is the huge building to the south-east of here. But when I came there, they attacked me.");
                    ppd->guiwynn_state++;
                    didsay = 1;
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    quiet_say(cn, "If thou couldst go there and find out, I would reward thee. I am suspecting some kind of disease, or a magical attack, or some kind of poisoning, maybe with the help of an alchemistical potion. If thou findst anything out of the ordinary, bring it to me.");
                    ppd->guiwynn_state++;
                    didsay = 1;
                ...
                case 5:
                    if (realtime - ppd->guiwynn_seen_timer > 60) {
                        quiet_say(cn, "Be greeted, %s! Didst thou find out anything about the Order? Or dost thou want me to \260c4repeat\260c0 mine offer?", ch[co].name);
                        didsay = 1;
                    }
                    break;

                case 6:
                    if (questlog_isdone(co, 8)) {
                ...
                case 8:
                    if (realtime - ppd->guiwynn_seen_timer > 60) {
                        quiet_say(cn, "Be greeted, %s! Didst thou find the recipe? Or dost thou want me to \260c4repeat\260c0 mine offer?", ch[co].name);
                        didsay = 1;
                    }
                    break;
                case 9:
                    quiet_say(cn, "Oh, how sad. This madness is not curable. They will remain mad for the rest of their life. But at least I tried.");
                    ppd->guiwynn_state++;
                    didsay = 1;
                    break;
                case 10:
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_AREA1_PPD, sizeof(struct area1_ppd));
                if (ppd && ppd->guiwynn_state <= 5) {
                    dat->last_talk = 0;
                    ppd->guiwynn_state = 0;
                }
                if (ppd && ppd->guiwynn_state >= 6 && ppd->guiwynn_state <= 8) {
                    dat->last_talk = 0;
                    ppd->guiwynn_state = 6;
                }
                if (ppd && ppd->guiwynn_state >= 9 && ppd->guiwynn_state <= 11) {
                    dat->last_talk = 0;
                    ppd->guiwynn_state = 9;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    if (ppd->guiwynn_state < 11) break; // dont offer quest before mad mages is done
                    ...
                    break;
                case 1:
                    quiet_say(cn, "My name is %s. I used to train the young knights from the Brotherhood of Knights on the eastern edge of town. But when I went there a few days ago, they started to behave very strangely.", ch[cn].name);
                    ppd->logain_state++;
                    didsay = 1;
                    break;
                case 2:
                    quiet_say(cn, "I gathered they had used some strength potions to increase their abilities. I was about to find out more, but they got aggressive and a fight was about to start, so I left.");
                    ppd->logain_state++;
                    didsay = 1;
                    break;
                case 3:
                    quiet_say(cn, "One day later, I tried talking to them again, but they attacked me on sight. Even though I teach fighting, I am old. I could not win against a score of young men. All I could do was keep them away and escape.");
                    ppd->logain_state++;
                    didsay = 1;
                    break;
                case 4:
                    ...
                    break;
                case 5:
                    if (realtime - ppd->logain_seen_timer > 60) {
                        quiet_say(cn, "Hail thee, %s! Couldst thou find out who is responsible? Or dost thou want me to \260c4repeat\260c0 mine offer?", ch[co].name);
                        didsay = 1;
                    }
                    break;
                case 6:
                    quiet_say(cn, "Loisan? This is strange indeed. Loisan used to live next door to this tavern. I cannot say I knew him very well, since he hardly ever left his home. He is gone now, anyway.");
                    ppd->logain_state++;
                    didsay = 1;
                    break;
                case 7:
                    quiet_say(cn, "He left for Aston a few days... Wait, he left for Aston the very day the Knights started to behave strangely. He even left the key to his house with me, asked me to look after it.");
                    ppd->logain_state++;
                    didsay = 1;
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_AREA1_PPD, sizeof(struct area1_ppd));
                if (ppd && ppd->logain_state <= 5) {
                    dat->last_talk = 0;
                    ppd->logain_state = 0;
                }
                if (ppd && ppd->logain_state >= 6 && ppd->logain_state <= 9) {
                    dat->last_talk = 0;
                    ppd->logain_state = 6;
                }
                break;
...
int ch_driver(int nr, int cn, int ret, int lastact) {
    switch (nr) {
    case CDR_GWENDYLON:
        gwendylon_driver(cn, ret, lastact);
        return 1;
    case CDR_YOAKIN:
        yoakin_driver(cn, ret, lastact);
        return 1;
    case CDR_BALLTRAP:
        balltrap_skelly_driver(cn, ret, lastact);
        return 1;
    case CDR_TERION:
        terion_driver(cn, ret, lastact);
        return 1;
    case CDR_JAMES:
        james_driver(cn, ret, lastact);
        return 1;
    case CDR_NOOK:
        nook_driver(cn, ret, lastact);
        return 1;
    case CDR_LYDIA:
        lydia_driver(cn, ret, lastact);
        return 1;
    case CDR_ROBBER:
        robber_driver(cn, ret, lastact);
        return 1;
    case CDR_SANOA:
        sanoa_driver(cn, ret, lastact);
        return 1;
    case CDR_ASTURIN:
        asturin_driver(cn, ret, lastact);
        return 1;
    case CDR_RESKIN:
        reskin_driver(cn, ret, lastact);
        return 1;
    case CDR_GUIWYNN:
        guiwynn_driver(cn, ret, lastact);
        return 1;
    case CDR_LOGAIN:
        logain_driver(cn, ret, lastact);
        return 1;
...
int ch_died_driver(int nr, int cn, int co) {
    switch (nr) {
    case CDR_GWENDYLON:
        gwendylon_dead(cn, co);
        return 1;
    case CDR_YOAKIN:
        gwendylon_dead(cn, co);
        return 1;
    case CDR_BALLTRAP:
        balltrap_skelly_dead(cn, co);
        return 1;
    case CDR_TERION:
        gwendylon_dead(cn, co);
        return 1;
...
int james_raisehint(int cn, int doraise) {
    ...
    if (ch[cn].value[1][V_FLASH] > 1 && ch[cn].value[1][V_FLASH] > ch[cn].value[1][V_FIRE]) {
        fire = 0;
        flash = 1;
    }
    if (ch[cn].value[1][V_FIRE] > 1 && ch[cn].value[1][V_FIRE] > ch[cn].value[1][V_FLASH]) {
        fire = 1;
        flash = 0;
    }
    ...
    if (misc) {
        for (v = 0; v < V_MAX; v++) {
            switch (v) {
            case V_HP:
                if ((ch[cn].flags & (CF_WARRIOR | CF_MAGE)) == CF_WARRIOR) weight = 2;
                else weight = 5;
                break;
            case V_MANA:
                if ((ch[cn].flags & (CF_WARRIOR | CF_MAGE)) == CF_MAGE) weight = 1;
                else weight = 3;
                break;
            case V_ENDURANCE:
                if (warcry) weight = 4;
...
void james_create_eq(int cn) {
    ...
    if (as) sprintf(buf, "armor%dq3", as);
    else sprintf(buf, "vest");
    if ((in = ch[cn].item[WN_BODY])) destroy_item(in);
    in = ch[cn].item[WN_BODY] = create_item(buf);
    it[in].mod_index[3] = V_WIS;
    it[in].mod_value[3] = ch[cn].level / 5;
    it[in].mod_index[4] = V_INT;
    it[in].mod_value[4] = ch[cn].level / 5;
    it[in].mod_index[2] = V_AGI;
    it[in].mod_value[2] = ch[cn].level / 5;
    it[in].carried = cn;

    if (as) sprintf(buf, "helmet%dq3", as);
    else sprintf(buf, "green_hat");
    if ((in = ch[cn].item[WN_HEAD])) destroy_item(in);
    in = ch[cn].item[WN_HEAD] = create_item(buf);
    it[in].mod_index[3] = V_STR;
    it[in].mod_value[3] = ch[cn].level / 5;
    it[in].mod_index[4] = V_DAGGER;
    it[in].mod_value[4] = ch[cn].level / 5;
    it[in].mod_index[2] = V_SWORD;
    it[in].mod_value[2] = ch[cn].level / 5;
    it[in].carried = cn;

    if (as) sprintf(buf, "sleeves%dq3", as);
    else sprintf(buf, "bracelet");
    if ((in = ch[cn].item[WN_ARMS])) destroy_item(in);
    in = ch[cn].item[WN_ARMS] = create_item(buf);
    it[in].mod_index[3] = V_ATTACK;
    it[in].mod_value[3] = ch[cn].level / 5;
    it[in].mod_index[4] = V_PARRY;
    it[in].mod_value[4] = ch[cn].level / 5;
    it[in].mod_index[2] = V_TACTICS;
    it[in].mod_value[2] = ch[cn].level / 5;
    it[in].carried = cn;

    if (as) sprintf(buf, "leggings%dq3", as);
    else sprintf(buf, "trousers");
    if ((in = ch[cn].item[WN_LEGS])) destroy_item(in);
    in = ch[cn].item[WN_LEGS] = create_item(buf);
    it[in].mod_index[3] = V_BLESS;
    it[in].mod_value[3] = ch[cn].level / 5;
    it[in].mod_index[4] = V_FLASH;
    it[in].mod_value[4] = ch[cn].level / 5;
    it[in].mod_index[2] = V_MAGICSHIELD;
    it[in].mod_value[2] = ch[cn].level / 5;
    it[in].carried = cn;

    if (ch[cn].flags & CF_WARRIOR) sprintf(buf, "sword%dq3", ws);
    else sprintf(buf, "dagger%dq3", ws);
    if ((in = ch[cn].item[WN_RHAND])) destroy_item(in);
    in = ch[cn].item[WN_RHAND] = create_item(buf);
    it[in].mod_index[3] = V_IMMUNITY;
    it[in].mod_value[3] = ch[cn].level / 5;
    it[in].mod_index[4] = V_HP;
    it[in].mod_value[4] = ch[cn].level / 5;
    it[in].mod_index[2] = V_MANA;
    it[in].mod_value[2] = ch[cn].level / 5;
    it[in].carried = cn;
