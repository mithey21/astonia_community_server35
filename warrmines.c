    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    break; // waiting for player to save first miner
                ...
                case 5:
                    ...
                    break;
                case 6:
                    break; // waiting for player to save second miner
                ...
                case 8:
                    ...
                    break;
                case 9:
                    break; // waiting for player to save third miner
                ...
                case 11:
                    ...
                    break;
                case 12:
                    break; // waiting for player to save fourth miner
        ...
        if (msg->type == NT_TEXT) {
            ...
            if (ch[co].flags & CF_PLAYER) {
                ...
                case 2:
                    if (ppd && ppd->dwarfchief_state <= 3) {
                        dat->last_talk = 0;
                        ppd->dwarfchief_state = 0;
                    }
                    if (ppd && ppd->dwarfchief_state >= 5 && ppd->dwarfchief_state <= 6) {
                        dat->last_talk = 0;
                        ppd->dwarfchief_state = 5;
                    }
                    if (ppd && ppd->dwarfchief_state >= 8 && ppd->dwarfchief_state <= 9) {
                        dat->last_talk = 0;
                        ppd->dwarfchief_state = 8;
                    }
                    if (ppd && ppd->dwarfchief_state >= 11 && ppd->dwarfchief_state <= 12) {
                        dat->last_talk = 0;
                        ppd->dwarfchief_state = 11;
                    }
                    if (ppd && ppd->dwarfchief_state >= 14 && ppd->dwarfchief_state <= 15) {
                        dat->last_talk = 0;
                        ppd->dwarfchief_state = 14;
                    }
                    break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    break; // waiting for teeth

                case 3:
                    if (questlog_isdone(co, 52)) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    break; // waiting for berries

                case 6:
                    if (questlog_isdone(co, 53)) {
        ...
        if (msg->type == NT_TEXT) {
            ...
            if (ch[co].flags & CF_PLAYER) {
                ...
                switch ((didsay = analyse_text_driver(cn, msg->dat1, (char *)msg->dat2, co))) {
                case 2:
                    if (ppd && ppd->dwarfshaman_state <= 2) {
                        dat->last_talk = 0;
                        ppd->dwarfshaman_state = 0;
                    }
                    if (ppd && ppd->dwarfshaman_state >= 3 && ppd->dwarfshaman_state <= 5) {
                        dat->last_talk = 0;
                        ppd->dwarfshaman_state = 3;
                    }
                    if (ppd && ppd->dwarfshaman_state >= 6 && ppd->dwarfshaman_state <= 8) {
                        dat->last_talk = 0;
                        ppd->dwarfshaman_state = 6;
                    }
                    if (ppd && ppd->dwarfshaman_state >= 9 && ppd->dwarfshaman_state <= 11) {
                        dat->last_talk = 0;
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    break; // waiting for mold
                case 2:
                    break; // waiting for silver
                }
                if (didsay) {
                    dat->last_talk = ticker;
                    talkdir = offset2dx(ch[cn].x, ch[cn].y, ch[co].x, ch[co].y);
            ...
            if ((in = ch[cn].citem)) { // we still have it
                if (it[in].ID == IID_LIZARDMOLD && ppd && ppd->dwarfsmith_state <= 1) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        in2 = create_item("lizard_elite_key2");
                        break;
                    case 3:
                        in2 = create_item("lizard_elite_key3");
                        break;
                    default:
                        in2 = 0;
                        quiet_say(cn, "oops. bug # 3266/%d", ppd->dwarfsmith_type);
                        break;
                    }
                    if (in2) {
...
void lostdwarf_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            // only talk every ten seconds
            if (ticker < dat->last_talk + TICKS * 60) {
                remove_message(cn, msg);
                continue;
            }
...
void pick_berry(int in, int cn) {
    ...
    case 1:
        in2 = create_item("lizard_brown_berry");
        break;
    case 2:
        in2 = create_item("picked_flower_h");
        break;
    case 3:
        in2 = create_item("picked_flower_i");
        break;
    case 4:
        in2 = create_item("picked_flower_j");
        break;

    default:
        log_char(cn, LOG_SYSTEM, 0, "Bug # 4111c");
        return;
    }
...
int ch_driver(int nr, int cn, int ret, int lastact) {
    switch (nr) {
    case CDR_DWARFCHIEF:
        dwarfchief_driver(cn, ret, lastact);
        return 1;
    case CDR_LOSTDWARF:
        lostdwarf_driver(cn, ret, lastact);
        return 1;
    case CDR_DWARFSHAMAN:
        dwarfshaman_driver(cn, ret, lastact);
        return 1;
    case CDR_DWARFSMITH:
        dwarfsmith_driver(cn, ret, lastact);
        return 1;
