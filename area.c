...
void show_section(int x, int y, int cn) {
    ...
    switch (diff) {
    case -5:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is too easy for you. (%d,%d)", sec->name, x, y);
        return;
    case -4:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is easy for you. (%d,%d)", sec->name, x, y);
        return;
    case -3:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is fairly easy for you. (%d,%d)", sec->name, x, y);
        return;
    case -2:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is rather easy for you. (%d,%d)", sec->name, x, y);
        return;
    case -1:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is just about right for you. (%d,%d)", sec->name, x, y);
        return;
    case 0:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is just right for you. (%d,%d)", sec->name, x, y);
        return;
    case 1:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is slightly dangerous for you. (%d,%d)", sec->name, x, y);
        return;
    case 2:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is a bit dangerous for you. (%d,%d)", sec->name, x, y);
        return;
    case 3:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is somewhat dangerous for you. (%d,%d)", sec->name, x, y);
        return;
    case 4:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is dangerous for you. (%d,%d)", sec->name, x, y);
        return;
    case 5:
        log_char(cn, LOG_SYSTEM, 0, "%s. This area is very dangerous for you. (%d,%d)", sec->name, x, y);
        return;
    }
}
