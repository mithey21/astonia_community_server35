...
void tree_driver(int in, int cn) {
    ...
    if (!cn) {
        if (is_fullnight()) {
            sprite = 51631;
            desc = "A silver chain is hanging from one twig of this three.";
        } else {
            sprite = 16006;
            desc = "A dead tree.";
        }
...
void pede_driver(int in, int cn) {
    ...
    if (!cn) {
        if (is_fullnight()) {
            sprite = 51636;
            desc = "A crystal is floating above a pedestal of stone.";
        } else {
            sprite = 51637;
            desc = "A pedestal made of rock.";
        }
...
void rock_driver(int in, int cn) {
    ...
    if (!cn) {
        if (is_fullnight()) {
            sprite = 51632;
            desc = "A piece of silver seems to be stuck below this rock.";
        } else {
            sprite = 59763;
            desc = "A big rock.";
        }
...
int ch_driver(int nr, int cn, int ret, int lastact) {
    switch (nr) {
    case CDR_SHR_WEREWOLF:
        shr_werewolf_driver(cn, ret, lastact);
        return 1;
