    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    sppd = set_data(co, DRD_STAFFER_PPD, sizeof(struct staffer_ppd));
                ...
                case 2:
                    ...
                    break;
                case 3:
                    say(cn, "So the Imperial Army has managed to keep them at bay for now? That is good to know.");
                    ppd->rammy_state++;
                    didsay = 1;
                    break;
                case 4:
                    say(cn, "Perhaps it is time for Arkhata to re-establish contact with the outside world. Please report back to the guard that we wish to open our passages to the city of Brannington.");
                    ppd->rammy_state++;
                    didsay = 1;
                    break;
                case 5:
                ...
                case 7:
                    say(cn, "Welcome back, friend!");
                    questlog_open(co, 65);
                    ppd->rammy_state++;
                    didsay = 1;
                    break;
                case 8:
                    say(cn, "A gang of bandits robbed me of my most precious item, my crown! They traveled south, past the fortress.");
                    ppd->rammy_state++;
                    didsay = 1;
                    break;
                case 9:
                    say(cn, "Now, dear Adventurer, I ask thee to go there and return my crown. I would reward thee!");
                    ppd->rammy_state++;
                    didsay = 1;
                    break;
                case 10:
                    break; // waiting for crown

                case 11:
                    say(cn, "May Ishtar be with thee, I am forever grateful.");
                    ppd->rammy_state++;
                    didsay = 1;
                    break;
                case 12:
                    say(cn, "My friend Jaz in the town has asked for assistance, but I have no guards to spare. Wouldst thou be kind enough to visit him?");
                    ppd->rammy_state++;
                    didsay = 1;
                    break;
                case 13:
                    if (ch[co].level >= 54 && ppd->monk_state >= 20) {
                        questlog_open(co, 71);
                        ppd->rammy_state++;
                    } else break;
                case 14:
                    ...
                    break;
                case 15:
                    say(cn, "It is not their fault as they have been trained for that. They know only citizens of Arkhata, and enemies.");
                    ppd->rammy_state++;
                    didsay = 1;
                    break;
                case 16:
                    ...
                    break;
                case 17:
                    if (ppd->letter_bits == (2 | 4 | 8)) ppd->rammy_state++;
                    else break;
                case 18:
                    say(cn, "Yet again thou hast been of great aid. The trade route is open and safe thanks to thee.");
                    questlog_done(co, 71);
                    ppd->rammy_state++;
                    didsay = 1;
                    break;
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->rammy_state <= 6) {
                    dat->last_talk = 0;
                    ppd->rammy_state = 0;
                }
                if (ppd && ppd->rammy_state >= 7 && ppd->rammy_state <= 10) {
                    dat->last_talk = 0;
                    ppd->rammy_state = 7;
                }
                if (ppd && ppd->rammy_state >= 12 && ppd->rammy_state <= 13) {
                    dat->last_talk = 0;
                    ppd->rammy_state = 12;
                }
                if (ppd && ppd->rammy_state >= 14 && ppd->rammy_state <= 17) {
                    dat->last_talk = 0;
                    ppd->rammy_state = 14;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    if (ppd->rammy_state >= 12) ppd->jaz_state++;
                    else break;
                case 1:
                    say(cn, "Welcome to my home, fellow adventurer. Couldst thou please spare a moment?");
                    questlog_open(co, 66);
                    ppd->jaz_state++;
                    didsay = 1;
                    break;
                case 2:
                    say(cn, "While I was traveling, I found a bug house. It was full of strong Knogers. When I reached the main room, the Knogers attacked me.");
                    ppd->jaz_state++;
                    didsay = 1;
                    break;
                case 3:
                ...
                case 7:
                    ...
                    break;
                case 8:
                    say(cn, "Cross the river, follow the path to the south-west, cross the river again using the long and winding bridge to reach the academy.");
                    ppd->jaz_state++;
                    didsay = 1;
                    break;
                case 9:
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->jaz_state <= 5) {
                    dat->last_talk = 0;
                    ppd->jaz_state = 0;
                }
                if (ppd && ppd->jaz_state >= 6 && ppd->jaz_state <= 9) {
                    dat->last_talk = 0;
                    ppd->jaz_state = 6;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 1:
                    say(cn, "Hello there stranger, and welcome to my Academy of the Fighting Arts. I can train thy abillities here if thou provest thine worth first.");
                    questlog_open(co, 67);
                    ppd->fiona_state++;
                    didsay = 1;
                    break;
                case 2:
                    say(cn, "I ventured into the vampire lair a few days ago, and suddenly my ring disappeared. And my students need me here so I can't retrieve it myself. Please bring it back to me. The lair is on the cemetery east of the Knoger residence.");
                    ppd->fiona_state++;
                    didsay = 1;
                    break;
                case 3:
                ...
                case 5:
                    ...
                    break;
                case 6:
                    say(cn, "To fight my student say \260c4enter\260c0! (Offer valid only for level 80 and below). Or thou might go back to town and give Ramin a hand.");
                    ppd->fiona_state++;
                    didsay = 1;
                    break;
                case 7:
                    break; // fighting gladiator 1
                case 8:
                    break; // fighting gladiator 2
                case 9:
                    break; // fighting gladiator 3
                case 10:
                    break; // fighting gladiator 4
                case 11:
                    break; // fighting gladiator 5
                case 12:
                    break; // fighting gladiator 6
                case 13:
                    break; // fighting gladiator 7
                case 14:
                    break; // fighting gladiator 8
                case 15:
                    break; // fighting gladiator 9
                case 16:
                ...
                case 17:
                    ...
                    break;
                case 18:
                    break; // waiting for skill choice;
                case 19:
                    say(cn, "Fare thee well, %s.", ch[co].name);
                    ppd->fiona_state++;
                    didsay = 1;
                    break;
                case 20:
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->fiona_state <= 3) {
                    dat->last_talk = 0;
                    ppd->fiona_state = 0;
                }
                if (ppd && ppd->fiona_state >= 5 && ppd->fiona_state <= 7) {
                    dat->last_talk = 0;
                    ppd->fiona_state = 5;
                }
                if (ppd && ppd->fiona_state >= 17 && ppd->fiona_state <= 18) {
                    dat->last_talk = 0;
                    ppd->fiona_state = 17;
                }
                if (ppd && ppd->fiona_state >= 19 && ppd->fiona_state <= 20) {
                    dat->last_talk = 0;
                    ppd->fiona_state = 19;
                }
                break;
...
void ramin_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    say(cn, "One of the traders has reported that he found a strange hole in his bedroom corner a few days ago.");
                    ppd->ramin_state++;
                    didsay = 1;
                    break;
                case 4:
                    ...
                    break;
                case 5:
                    say(cn, "I would have sent a soldier for this but Rammy says he doesn't have any to spare from the fortress. Mayest thou go instead, explore this hole and destroy any dangers within it?");
                    ppd->ramin_state++;
                    didsay = 1;
                    break;
                case 6:
                    break; // waiting for player to kill all skellies
                case 7:
                    say(cn, "The trader and I thank thee for thy help. Now he may sleep at night again.");
                    ppd->ramin_state++;
                    didsay = 1;
                    break;
                case 8:
                    say(cn, "Also, I hear there is something going on in the library, wouldst thou please visit the monks there?");
                    ppd->ramin_state++;
                    didsay = 1;
                    break;
                case 9:
                ...
                case 10:
                    if (ppd->rammy_state < 14) say(cn, "Greetings my friend! I hear that thou have helped the monks. Now Rammy has sent me news about trouble opening the fortress for a trade route, he is in need of thy help again. Please go and talk to him.");
                    ppd->ramin_state++;
                    didsay = 1;
                    break;
                case 11:
                ...
                case 12:
                    ...
                    break;
                case 13:
                    say(cn, "I know from the library books, diaries of the early years here, that when we first arrived it was a peaceful and uninhabited place.");
                    ppd->ramin_state++;
                    didsay = 1;
                    break;
                case 14:
                    say(cn, "Now we have monsters everywhere, it is odd. Seems almost as if a source of some kind generates evil.");
                    ppd->ramin_state++;
                    didsay = 1;
                    break;
                case 15:
                    say(cn, "Go speak to Jada in the house next door. She is my most trusted officer in matters of the mystical.");
                    ppd->ramin_state++;
                    didsay = 1;
                    break;
                case 16:
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->ramin_state <= 6) {
                    dat->last_talk = 0;
                    ppd->ramin_state = 0;
                }
                if (ppd && ppd->ramin_state >= 7 && ppd->ramin_state <= 9) {
                    dat->last_talk = 0;
                    ppd->ramin_state = 7;
                }
                if (ppd && ppd->ramin_state >= 10 && ppd->ramin_state <= 11) {
                    dat->last_talk = 0;
                    ppd->ramin_state = 10;
                }
                if (ppd && ppd->ramin_state >= 12 && ppd->ramin_state <= 16) {
                    dat->last_talk = 0;
                    ppd->ramin_state = 12;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    if (ppd->ramin_state >= 7) ppd->monk_state++;
                    else break;
                case 1:
                    if (nr == 1) {
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->monk_state >= 8 && ppd->monk_state <= 12) {
                    dat->last_talk = 0;
                    ppd->monk_state = 8;
                }
                if (ppd && ppd->monk_state >= 15 && ppd->monk_state <= 19) {
                    dat->last_talk = 0;
                    ppd->monk_state = 15;
                }
                if (ppd && ppd->monk_state >= 21 && ppd->monk_state <= 28) {
                    dat->last_talk = 0;
                    ppd->monk_state = 21;
                }
                break;
...
void captain_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    say(cn, "I believe we will need an entrance pass system to allow travellers to pass through the fortress safely. I can inform the guards of this.");
                    ppd->captain_state++;
                    didsay = 1;
                    break;
                case 3:
                    say(cn, "I need thee to speak with the judge so that he can write the formal authorization letters for this. He will also tell thee who needs a copy.");
                    ppd->captain_state++;
                    didsay = 1;
                    break;
                case 4:
                    if (ch[co].level >= 53 && ppd->judge_state >= 6 && ppd->letter_bits == (2 | 4 | 8)) ppd->captain_state++;
                    else break;
                case 5:
                    say(cn, "This fortress holds many secrets, known only to me and a select few of my guards for safety reasons. But now there is a leak.");
                    ppd->captain_state++;
                    didsay = 1;
                    break;
                case 6:
                    say(cn, "A traitor was caught last night, on his way to the bandits carrying classified notes stolen from our archive.");
                    ppd->captain_state++;
                    didsay = 1;
                    break;
                case 7:
                    say(cn, "He was caught in the act, but even under torture we have failed to make him speak.");
                    ppd->captain_state++;
                    didsay = 1;
                    break;
                case 8:
                    ...
                    break;
                case 9:
                    say(cn, "And a little warning. Thy entrance pass is only valid in open areas of the fortress, some places my guard will attack thee still.");
                    ppd->captain_state++;
                    didsay = 1;
                    break;
                case 10:
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->captain_state > 0 && ppd->captain_state <= 4 && ppd->judge_state == 0) {
                    dat->last_talk = 0;
                    ppd->captain_state = 1;
                }
                if (ppd && ppd->captain_state >= 5 && ppd->captain_state <= 10) {
                    dat->last_talk = 0;
                    ppd->captain_state = 5;
                }
                break;
...
void judge_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    say(cn, "Here, take these three agreements, one for Ramin, one for Count Brannington and one for the fortress Captain.");
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->judge_state > 0 && ppd->judge_state <= 6 && ppd->letter_bits != (2 | 4 | 8)) {
                    dat->last_talk = 0;
                    ppd->judge_state = 1;
                }
                if (ppd && ppd->judge_state > 0 && ppd->judge_state <= 6 && ppd->letter_bits == (2 | 4 | 8)) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    if (ppd->ramin_state >= 12) ppd->jada_state++;
                    else break;
                case 1:
                    say(cn, "Hello there, %s. Thou hast been sent from Ramin I see.", ch[co].name);
                    questlog_open(co, 72);
                    ppd->jada_state++;
                    didsay = 1;
                    break;
                ...
                case 3:
                    ...
                    break;
                case 4:
                    break; // waiting for blade
                case 5:
                    break; // got blade, all done
                }
                if (didsay) {
                    dat->last_talk = ticker;
                    talkdir = offset2dx(ch[cn].x, ch[cn].y, ch[co].x, ch[co].y);
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->jada_state > 0 && ppd->jada_state <= 4) {
                    dat->last_talk = 0;
                    ppd->jada_state = 1;
                }
                break;
...
void potmaker_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    say(cn, "It is quite a valuable pot, it can hold water in temperatures far below freezing without it turning to ice. Thai Pan has told me he could sense it's magic south of his temple, perhaps thou should search the forest in that direction.");
                    ppd->pot_state++;
                    didsay = 1;
                    break;
                case 3:
                    break; // waiting for pot
                case 4:
                    break; // got pot, all done
                }
                if (didsay) {
                    dat->last_talk = ticker;
                    talkdir = offset2dx(ch[cn].x, ch[cn].y, ch[co].x, ch[co].y);
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->pot_state > 0 && ppd->pot_state <= 3) {
                    dat->last_talk = 0;
                    ppd->pot_state = 1;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    if (ppd->pot_state >= 4) ppd->hunter_state = 4;
                    else if (ppd->pot_state > 0) ppd->hunter_state++;
                    else break;
                case 1:
                    say(cn, "Hail adventurer! I see thou are seeking for a ceremonial pot. Well that is an odd coincidence.");
                    ppd->hunter_state++;
                    didsay = 1;
                    break;
                case 2:
                    say(cn, "Last night I heard the strangest noises from the bandit's hideout, one of them came running out yelling about a frozen toe.");
                    ppd->hunter_state++;
                    didsay = 1;
                    break;
                case 3:
                    say(cn, "He made the wolf I was about to slay run away from me with all that screaming.");
                    ppd->hunter_state++;
                    didsay = 1;
                    break;
                case 4:
                ...
                case 5:
                    say(cn, "It's great to see thee again adventurer! News of thy deeds in Arkhata has reached even me.");
                    questlog_open(co, 77);
                    ppd->hunter_state++;
                    didsay = 1;
                    break;
                case 6:
                    say(cn, "Along with several complaints of a troublesome blue harpy. I have searched for it many a night.");
                    ppd->hunter_state++;
                    didsay = 1;
                    break;
                case 7:
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->hunter_state > 0 && ppd->hunter_state <= 4) {
                    dat->last_talk = 0;
                    ppd->hunter_state = 1;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 1:
                    say(cn, "Aaaaaaaaaaooooommmm... Oh, hello there friend. I'm Thai Pan, monk in this small place of worship. Thou are welcome to have a cup of green tea with me.");
                    questlog_open(co, 74);
                    ppd->thai_state++;
                    didsay = 1;
                    break;
                case 2:
                    say(cn, "I know many stories and there is one in particular I think will interest thee.");
                    ppd->thai_state++;
                    didsay = 1;
                    break;
                case 3:
                    say(cn, "It is said that the ruins on the shore north of here was once a sanctuary for scholars of my order.");
                    ppd->thai_state++;
                    didsay = 1;
                    break;
                case 4:
                    say(cn, "And that they were researching some ancient scrolls that somehow should lead them to a higher level of understanding.");
                    ppd->thai_state++;
                    didsay = 1;
                    break;
                case 5:
                    ...
                    break;
                case 6:
                    say(cn, "Now the ruins are occupied by zombies, who have inhabited the place for as long as I have records of.");
                    ppd->thai_state++;
                    didsay = 1;
                    break;
                case 7:
                    say(cn, "Very few have ventured there in recent years, but I am told that the place is filled with magic and holds a strange shrine.");
                    ppd->thai_state++;
                    didsay = 1;
                    break;
                case 8:
                    break; // waiting for scroll
                case 9:
                    break; // all done
                }
                if (didsay) {
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->thai_state > 0 && ppd->thai_state <= 8) {
                    dat->last_talk = 0;
                    ppd->thai_state = 1;
                }
                break;
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    if (ppd->captain_state >= 5) ppd->clerk_state++;
                    else break;
                case 1:
                    say(cn, "So the Captain sent thee to me? That is good.");
                    questlog_open(co, 76);
                    ppd->clerk_state++;
                    didsay = 1;
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    say(cn, "Are thou able to find these traitors in time? Thou will have three hours (Astonia time)! Say \260c04Aye\260c0 when thou are ready!");
                    ppd->clerk_state++;
                    didsay = 1;
                    break;
                case 4:
                ...
                case 5:
                    if (realtime - ppd->clerk_time > CLERKTIME) {
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->clerk_state > 0 && ppd->clerk_state <= 4) {
                    dat->last_talk = 0;
                    ppd->clerk_state = 1;
                }
                break;
...
void trainer_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    say(cn, "Now I believe the gang leader is torturing him, or worse, to learn our fighting secrets.");
                    ppd->trainer_state++;
                    didsay = 1;
                    break;
                case 5:
                    ...
                    break;
                case 6:
                    if (ppd->kid_state == 5) { // waiting for student to be rescued
                        questlog_done(co, 75);
                        ppd->trainer_state++;
                    } else break;
                case 7:
                    say(cn, "Thank thee great fighter. Now that my student is safe I can sleep at night. Thou have proven thy skills once again. The door to the academy will always be open to thee.");
                    ppd->trainer_state++;
                    didsay = 1;
                    break;
                case 8:
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ppd = set_data(co, DRD_ARKHATA_PPD, sizeof(struct arkhata_ppd));
                if (ppd && ppd->trainer_state > 0 && ppd->trainer_state <= 6) {
                    dat->last_talk = 0;
                    ppd->trainer_state = 1;
                }
                if (ppd && ppd->trainer_state >= 7 && ppd->trainer_state <= 8) {
                    dat->last_talk = 0;
                    ppd->trainer_state = 7;
                }
                break;
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if ((in = has_item(co, IID_ARKHATA_IRONPOTION))) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 0:
                    if (ppd->monk_state >= 29) ppd->krenach_state++;
                    else {
                ...
                case 1:
                    say(cn, "So thou have met my grandson? And he is well? Oh by the pickaxe's tip thou are one blessed human.");
                    questlog_done(co, 78);
                    ppd->krenach_state++;
                    didsay = 1;
                    break;
                case 2:
                    say(cn, "I am very happy to hear news of him. And to finally have someone to talk with.");
                    ppd->krenach_state++;
                    didsay = 1;
                    break;
                case 3:
                    say(cn, "10000g for a book is alot of money. I see thou have taken good care of it. Here take these 5000g from me. All in all, the price of thine adventure should be more reasonable now.");
                    give_money(co, 5000 * 100, "Krenach Dictionary Quest");
                    ppd->krenach_state++;
                    didsay = 1;
                    break;
                case 4:
                    say(cn, "Go in peace, human.");
                    ppd->krenach_state++;
                    didsay = 1;
                    break;
                }
...
void arkhata_item_driver(int in, int cn) {
    ...
    case 0:
        ...
        break;
    case 1:
        stopwatch_driver(in, cn);
        break;
    case 2:
        key_assemble_driver(in, cn);
        break;
    }
}
...
int ch_driver(int nr, int cn, int ret, int lastact) {
    switch (nr) {
    case CDR_RAMMY:
        rammy_driver(cn, ret, lastact);
        return 1;
    case CDR_JAZ:
        jaz_driver(cn, ret, lastact);
        return 1;
    case CDR_FIONA:
        fiona_driver(cn, ret, lastact);
        return 1;
    case CDR_BRIDGEGUARD:
        bridgeguard_driver(cn, ret, lastact);
        return 1;
    case CDR_GLADIATOR:
        gladiator_driver(cn, ret, lastact);
        return 1;
    case CDR_NOP:
        nop_driver(cn, ret, lastact);
        return 1;
    case CDR_RAMIN:
        ramin_driver(cn, ret, lastact);
        return 1;
    case CDR_ARKHATASKELLY:
        arkhataskelly_driver(cn, ret, lastact);
        return 1;
    case CDR_ARKHATAMONK:
        arkhatamonk_driver(cn, ret, lastact);
        return 1;
    case CDR_BOOKEATER:
        bookeater_driver(cn, ret, lastact);
        return 1;
    case CDR_CAPTAIN:
        captain_driver(cn, ret, lastact);
        return 1;
    case CDR_JUDGE:
        judge_driver(cn, ret, lastact);
        return 1;
    case CDR_FORTRESSGUARD:
        fortressguard_driver(cn, ret, lastact);
        return 1;
    case CDR_JADA:
        jada_driver(cn, ret, lastact);
        return 1;
    case CDR_POTMAKER:
        potmaker_driver(cn, ret, lastact);
        return 1;
    case CDR_HUNTER:
        hunter_driver(cn, ret, lastact);
        return 1;
    case CDR_THAIPAN:
        thaipan_driver(cn, ret, lastact);
        return 1;
    case CDR_TRAINER:
        trainer_driver(cn, ret, lastact);
        return 1;
    case CDR_KIDNAPPEE:
        kidnappee_driver(cn, ret, lastact);
        return 1;
    case CDR_ARKHATACLERK:
        clerk_driver(cn, ret, lastact);
        return 1;
    case CDR_ARKHATAPRISON:
        prisoner_driver(cn, ret, lastact);
        return 1;
    case CDR_KRENACH:
        krenach_driver(cn, ret, lastact);
        return 1;
    case CDR_MADHERMIT:
        madhermit_driver(cn, ret, lastact);
        return 1;
...
int ch_died_driver(int nr, int cn, int co) {
    ...
    case CDR_BRIDGEGUARD:
        return 1;
    case CDR_GLADIATOR:
        gladiator_dead(cn, co);
        return 1;
    case CDR_NOP:
        immortal_dead(cn, co);
        return 1;
    case CDR_ARKHATASKELLY:
        arkhataskelly_dead(cn, co);
        return 1;
    case CDR_ARKHATAMONK:
        immortal_dead(cn, co);
        return 1;
    case CDR_BOOKEATER:
        bookeater_dead(cn, co);
        return 1;
    case CDR_CAPTAIN:
        immortal_dead(cn, co);
        return 1;
