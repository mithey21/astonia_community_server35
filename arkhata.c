        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    say(cn, "To fight my student say °c4enter°c0! (Offer valid only for level 80 and below). Or thou might go back to town and give Ramin a hand.");
                    ppd->fiona_state++;
                    didsay = 1;
                    break;
                case 7:
        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    say(cn, "Are thou able to find these traitors in time? Thou will have three hours (Astonia time)! Say °c04Aye°c0 when thou are ready!");
                    ppd->clerk_state++;
                    didsay = 1;
                    break;
                case 4:
