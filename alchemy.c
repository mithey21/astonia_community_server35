...
int mixer_mix(int cn, int in, int power, int duration, double divi) {
    ...
    if (cnt == 5 && wis == 1 && inu == 1 && agi == 2 && str == 1) { // sword attack parry
        ...
        for (n = 0; n < 3; n++) {
            if (wis) {
                skl[n] = V_WIS;
                if ((val[n] = power * wis / divi / cnt / 4)) flag = 1;
                wis = 0;
                continue;
            }
            if (inu) {
                skl[n] = V_INT;
                if ((val[n] = power * inu / divi / cnt / 4)) flag = 1;
                inu = 0;
                continue;
            }
            if (agi) {
                skl[n] = V_AGI;
                if ((val[n] = power * agi / divi / cnt / 4)) flag = 1;
                agi = 0;
                continue;
            }
            if (str) {
                skl[n] = V_STR;
                if ((val[n] = power * str / divi / cnt / 4)) flag = 1;
                str = 0;
                continue;
            }
            if (lfe) {
                skl[n] = V_HP;
                if ((val[n] = power * lfe / divi / cnt / 2)) flag = 1;
                lfe = 0;
                continue;
            }
            if (spr) {
                skl[n] = V_MANA;
                if ((val[n] = power * spr / divi / cnt / 2)) flag = 1;
                spr = 0;
                continue;
            }
            if (end) {
                skl[n] = V_ENDURANCE;
                if ((val[n] = power * end / divi / cnt / 2)) flag = 1;
                end = 0;
                continue;
            }
            skl[n] = -1;
...
void flask_driver(int in, int cn) {
    ...
    if (!(in2 = ch[cn].citem)) {
        if (shaken) { // potion is ready
            ...
            case 1:
                it[in].sprite = 10290;
                strcpy(it[in].description, "A small flask made of glass.");
                break;
            case 2:
                it[in].sprite = 10294;
                strcpy(it[in].description, "A flask made of glass.");
                break;
            case 3:
                it[in].sprite = 10302;
                strcpy(it[in].description, "A big flask made of glass.");
                break;
            default:
                elog("umpsi dumpsi (%s)", it[in].name);
                break;
            }
        ...
        if (mixer(cn, in)) {
            ...
            case 1:
                it[in].sprite = 50213;
                strcpy(it[in].description, "A small flask containing a magical liquid.");
                break;
            case 2:
                it[in].sprite = 50214;
                strcpy(it[in].description, "A flask containing a magical liquid.");
                break;
            case 3:
                it[in].sprite = 50253;
                strcpy(it[in].description, "A big flask containing a magical liquid.");
                break;

            default:
                elog("humba dumba (%s)", it[in].name);
                break;
            }
    ...
    switch (size) {
    case 1:
        it[in].sprite = 50204 + used;
        strcpy(it[in].description, "A small flask containing some strange liquid.");
        break;
    case 2:
        it[in].sprite = 50207 + used;
        strcpy(it[in].description, "A flask containing some strange liquid.");
        break;
    case 3:
        it[in].sprite = 50243 + used;
        strcpy(it[in].description, "A big flask containing some strange liquid.");
        break;
    default:
        elog("uhga ugha (%s)", it[in].name);
        break;
    }
...
void flower_driver(int in, int cn) {
    ...
    switch (it[in].drdata[0]) {
    case 1:
        in2 = create_item("alc_flower1");
        break;
    case 2:
        in2 = create_item("alc_flower2");
        break;
    case 3:
        in2 = create_item("alc_flower3");
        break;
    case 4:
        in2 = create_item("alc_flower4");
        break;
    case 5:
        in2 = create_item("alc_flower5");
        break;
    case 6:
        in2 = create_item("alc_flower6");
        break;
    case 7:
        in2 = create_item("alc_flower7");
        break;
    case 8:
        in2 = create_item("alc_mushroom1");
        break;
    case 9:
        in2 = create_item("alc_mushroom2");
        break;
    case 10:
        in2 = create_item("alc_mushroom3");
        break;
    case 11:
        in2 = create_item("alc_mushroom4");
        break;
    case 12:
        in2 = create_item("alc_mushroom5");
        break;
    case 13:
        in2 = create_item("alc_mushroom6");
        break;
    case 14:
        in2 = create_item("alc_mushroom7");
        break;
    case 15:
        in2 = create_item("alc_mushroom8");
        break;
    case 16:
        in2 = create_item("alc_mushroom9");
        break;
    case 17:
        in2 = create_item("alc_berry1");
        break;
    case 18:
        in2 = create_item("alc_berry2");
        break;
    case 19:
        in2 = create_item("alc_berry3");
        break;
    case 20:
        in2 = create_item("alc_berry4");
        break;

    default:
        log_char(cn, LOG_SYSTEM, 0, "Bug # 4111");
        return;
    }
